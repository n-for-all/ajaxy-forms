...
use Isolated\Egulias\EmailValidator\Warning\QuotedPart;
use Isolated\Egulias\EmailValidator\Result\InvalidEmail;
use Isolated\Egulias\EmailValidator\Parser\CommentStrategy\CommentStrategy;
use Isolated\Egulias\EmailValidator\Result\Reason\UnclosedComment;
use Isolated\Egulias\EmailValidator\Result\Reason\UnOpenedComment;
use Isolated\Egulias\EmailValidator\Warning\Comment as WarningComment;
class Comment extends PartParser
{
    ...
    private function warnEscaping() : bool
    {
        ...
        $this->warnings[QuotedPart::CODE] = new QuotedPart($this->lexer->getPrevious()['type'], ((array) $this->lexer->token)['type']);
        return \true;
    }
