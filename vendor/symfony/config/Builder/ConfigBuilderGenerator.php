...
use Isolated\Symfony\Component\Config\Definition\ArrayNode;
use Isolated\Symfony\Component\Config\Definition\BooleanNode;
use Isolated\Symfony\Component\Config\Definition\ConfigurationInterface;
use Isolated\Symfony\Component\Config\Definition\EnumNode;
use Isolated\Symfony\Component\Config\Definition\Exception\InvalidConfigurationException;
use Isolated\Symfony\Component\Config\Definition\FloatNode;
use Isolated\Symfony\Component\Config\Definition\IntegerNode;
use Isolated\Symfony\Component\Config\Definition\NodeInterface;
use Isolated\Symfony\Component\Config\Definition\PrototypedArrayNode;
use Isolated\Symfony\Component\Config\Definition\ScalarNode;
use Isolated\Symfony\Component\Config\Definition\VariableNode;
use Isolated\Symfony\Component\Config\Loader\ParamConfigurator;
/**
...
class ConfigBuilderGenerator implements ConfigBuilderGeneratorInterface
{
    ...
    public function build(ConfigurationInterface $configuration) : \Closure
    {
        ...
        $rootClass = new ClassBuilder('Isolated\\Symfony\\Config', $rootNode->getName());
