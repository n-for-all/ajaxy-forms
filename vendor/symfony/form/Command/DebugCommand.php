 ...
 */
namespace Isolated\Symfony\Component\Form\Command;

use Isolated\Symfony\Component\Console\Command\Command;
use Isolated\Symfony\Component\Console\Completion\CompletionInput;
use Isolated\Symfony\Component\Console\Completion\CompletionSuggestions;
use Isolated\Symfony\Component\Console\Exception\InvalidArgumentException;
use Isolated\Symfony\Component\Console\Input\InputArgument;
use Isolated\Symfony\Component\Console\Input\InputInterface;
use Isolated\Symfony\Component\Console\Input\InputOption;
use Isolated\Symfony\Component\Console\Output\OutputInterface;
use Isolated\Symfony\Component\Console\Style\SymfonyStyle;
use Isolated\Symfony\Component\Form\Console\Helper\DescriptorHelper;
use Isolated\Symfony\Component\Form\Extension\Core\CoreExtension;
use Isolated\Symfony\Component\Form\FormRegistryInterface;
...
class DebugCommand extends Command
{
    ...
    public function __construct(FormRegistryInterface $formRegistry, array $namespaces = ['Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type'], array $types = [], array $extensions = [], array $guessers = [], FileLinkFormatter $fileLinkFormatter = null)
    {
        parent::__construct();
    ...
    {
        $this->setDefinition([new InputArgument('class', InputArgument::OPTIONAL, 'The form type class'), new InputArgument('option', InputArgument::OPTIONAL, 'The form type option'), new InputOption('show-deprecated', null, InputOption::VALUE_NONE, 'Display deprecated options in form types'), new InputOption('format', null, InputOption::VALUE_REQUIRED, 'The output format (txt or json)', 'txt')])->setDescription(self::$defaultDescription)->setHelp(<<<'EOF'
...
EOF
    ...
    private function getCoreTypes() : array
    {
        ...
        $loadTypesRefMethod->setAccessible(\true);
        $coreTypes = $loadTypesRefMethod->invoke($coreExtension);
        $coreTypes = \array_map(function (FormTypeInterface $type) {
