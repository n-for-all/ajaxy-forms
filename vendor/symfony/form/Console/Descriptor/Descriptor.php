...
use Isolated\Symfony\Component\Console\Descriptor\DescriptorInterface;
use Isolated\Symfony\Component\Console\Input\ArrayInput;
use Isolated\Symfony\Component\Console\Output\OutputInterface;
use Isolated\Symfony\Component\Console\Style\OutputStyle;
use Isolated\Symfony\Component\Console\Style\SymfonyStyle;
use Isolated\Symfony\Component\Form\ResolvedFormTypeInterface;
use Isolated\Symfony\Component\Form\Util\OptionsResolverWrapper;
use Isolated\Symfony\Component\OptionsResolver\Debug\OptionsResolverIntrospector;
use Isolated\Symfony\Component\OptionsResolver\Exception\NoConfigurationException;
...
abstract class Descriptor implements DescriptorInterface
{
    ...
    protected abstract function describeResolvedFormType(ResolvedFormTypeInterface $resolvedFormType, array $options = []);
    protected abstract function describeOption(OptionsResolver $optionsResolver, array $options);
    ...
    protected function getOptionDefinition(OptionsResolver $optionsResolver, string $option)
    {
        ...
        $definition += ['required' => $optionsResolver->isRequired($option), 'deprecated' => $optionsResolver->isDeprecated($option)];
        $introspector = new OptionsResolverIntrospector($optionsResolver);
        $map = ['default' => 'getDefault', 'lazy' => 'getLazyClosures', 'allowedTypes' => 'getAllowedTypes', 'allowedValues' => 'getAllowedValues', 'normalizers' => 'getNormalizers', 'deprecation' => 'getDeprecation'];
