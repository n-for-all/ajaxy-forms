...
class DateTimeToArrayTransformer extends BaseDateTimeTransformer
{
    ...
    public function transform($dateTime)
    {
        ...
        $result = \array_intersect_key(['year' => $dateTime->format('Y'), 'month' => $dateTime->format('m'), 'day' => $dateTime->format('d'), 'hour' => $dateTime->format('H'), 'minute' => $dateTime->format('i'), 'second' => $dateTime->format('s')], \array_flip($this->fields));
        if (!$this->pad) {
