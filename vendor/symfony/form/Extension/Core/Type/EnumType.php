...
final class EnumType extends AbstractType
{
    ...
    {
        $resolver->setRequired(['class'])->setAllowedTypes('class', 'string')->setAllowedValues('class', \Closure::fromCallable('enum_exists'))->setDefault('choices', static function (Options $options) : array {
            ...
            if (!\is_a($options['class'], \BackedEnum::class, \true)) {
                return null;
            }
