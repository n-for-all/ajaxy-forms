...
use Isolated\Symfony\Component\Intl\Languages;
...
class LanguageType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        }, 'choice_translation_domain' => \false, 'choice_translation_locale' => null, 'alpha3' => \false, 'choice_self_translation' => \false, 'invalid_message' => function (Options $options, $previousValue) {
            return $options['legacy_error_messages'] ?? \true ? $previousValue : 'Please select a valid language.';
        }]);
        ...
        $resolver->setNormalizer('choice_self_translation', function (Options $options, $value) {
            if (\true === $value && $options['choice_translation_locale']) {
