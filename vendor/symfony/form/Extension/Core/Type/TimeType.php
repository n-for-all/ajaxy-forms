...
class TimeType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if ('single_text' === $options['widget']) {
            ...
            $hourOptions = $minuteOptions = $secondOptions = ['error_bubbling' => \true, 'empty_data' => ''];
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $choiceTranslationDomainNormalizer = function (Options $options, $choiceTranslationDomain) {
            if (\is_array($choiceTranslationDomain)) {
                $default = \false;
                return \array_replace(['hour' => $default, 'minute' => $default, 'second' => $default], $choiceTranslationDomain);
            }
            return ['hour' => $choiceTranslationDomain, 'minute' => $choiceTranslationDomain, 'second' => $choiceTranslationDomain];
        };
        ...
        $resolver->setDefaults([
            ...
            'invalid_message' => function (Options $options, $previousValue) {
                return $options['legacy_error_messages'] ?? \true ? $previousValue : 'Please enter a valid time.';
            },
        ]);
