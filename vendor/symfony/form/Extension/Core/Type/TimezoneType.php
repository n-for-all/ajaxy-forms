...
use Isolated\Symfony\Component\Form\Extension\Core\DataTransformer\DateTimeZoneToStringTransformer;
use Isolated\Symfony\Component\Form\Extension\Core\DataTransformer\IntlTimeZoneToStringTransformer;
use Isolated\Symfony\Component\Form\FormBuilderInterface;
use Isolated\Symfony\Component\Intl\Intl;
use Isolated\Symfony\Component\Intl\Timezones;
...
class TimezoneType extends AbstractType
{
    ...
    {
        $resolver->setDefaults(['intl' => \false, 'choice_loader' => function (Options $options) {
            $input = $options['input'];
            if ($options['intl']) {
        ...
        }, 'choice_translation_domain' => \false, 'choice_translation_locale' => null, 'input' => 'string', 'invalid_message' => function (Options $options, $previousValue) {
            return $options['legacy_error_messages'] ?? \true ? $previousValue : 'Please select a valid timezone.';
