...
use Isolated\Symfony\Component\Form\Extension\Core\DataTransformer\UuidToStringTransformer;
...
class UuidType extends AbstractType
{
    ...
    {
        $builder->addViewTransformer(new UuidToStringTransformer());
    }
    /**
     * {@inheritdoc}
     */
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(['compound' => \false, 'invalid_message' => function (Options $options, $previousValue) {
            return $options['legacy_error_messages'] ?? \true ? $previousValue : 'Please enter a valid UUID.';
        }]);
    }
}
