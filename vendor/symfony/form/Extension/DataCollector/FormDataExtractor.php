...
class FormDataExtractor implements FormDataExtractorInterface
{
    ...
    {
        $data = ['id' => $this->buildId($form), 'name' => $form->getName(), 'type_class' => \get_class($form->getConfig()->getType()->getInnerType()), 'synchronized' => $form->isSynchronized(), 'passed_options' => [], 'resolved_options' => []];
    ...
    {
        $data = ['default_data' => ['norm' => $form->getNormData()], 'submitted_data' => []];
    ...
    {
        $data = ['submitted_data' => ['norm' => $form->getNormData()], 'errors' => []];
        if ($form->getViewData() !== $form->getNormData()) {
        ...
        foreach ($form->getErrors() as $error) {
            $errorData = ['message' => $error->getMessage(), 'origin' => \is_object($error->getOrigin()) ? \spl_object_hash($error->getOrigin()) : null, 'trace' => []];
