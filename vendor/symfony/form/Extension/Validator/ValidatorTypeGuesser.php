...
use Isolated\Symfony\Component\Form\FormTypeGuesserInterface;
use Isolated\Symfony\Component\Form\Guess\Guess;
use Isolated\Symfony\Component\Form\Guess\TypeGuess;
use Isolated\Symfony\Component\Form\Guess\ValueGuess;
use Isolated\Symfony\Component\Validator\Constraint;
use Isolated\Symfony\Component\Validator\Mapping\ClassMetadataInterface;
...
class ValidatorTypeGuesser implements FormTypeGuesserInterface
{
        ...
        switch (\get_class($constraint)) {
            case 'Symfony\\Component\\Validator\\Constraints\\Type':
                switch ($constraint->type) {
                    case 'array':
                        return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\CollectionType', [], Guess::MEDIUM_CONFIDENCE);
                    case 'boolean':
                    case 'bool':
                        return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\CheckboxType', [], Guess::MEDIUM_CONFIDENCE);
                    case 'double':
                    case 'float':
                    case 'numeric':
                    case 'real':
                        return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\NumberType', [], Guess::MEDIUM_CONFIDENCE);
                    case 'integer':
                    case 'int':
                    case 'long':
                        return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\IntegerType', [], Guess::MEDIUM_CONFIDENCE);
                    case \DateTime::class:
                    case '\\DateTime':
                        return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\DateType', [], Guess::MEDIUM_CONFIDENCE);
                    case 'string':
                        return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\TextType', [], Guess::LOW_CONFIDENCE);
                }
                break;
            case 'Symfony\\Component\\Validator\\Constraints\\Country':
                return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\CountryType', [], Guess::HIGH_CONFIDENCE);
            case 'Symfony\\Component\\Validator\\Constraints\\Currency':
                return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\CurrencyType', [], Guess::HIGH_CONFIDENCE);
            case 'Symfony\\Component\\Validator\\Constraints\\Date':
                return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\DateType', ['input' => 'string'], Guess::HIGH_CONFIDENCE);
            case 'Symfony\\Component\\Validator\\Constraints\\DateTime':
                return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\DateTimeType', ['input' => 'string'], Guess::HIGH_CONFIDENCE);
            case 'Symfony\\Component\\Validator\\Constraints\\Email':
                return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\EmailType', [], Guess::HIGH_CONFIDENCE);
            ...
            case 'Symfony\\Component\\Validator\\Constraints\\Image':
                ...
                return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\FileType', $options, Guess::HIGH_CONFIDENCE);
            case 'Symfony\\Component\\Validator\\Constraints\\Language':
                return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\LanguageType', [], Guess::HIGH_CONFIDENCE);
            case 'Symfony\\Component\\Validator\\Constraints\\Locale':
                return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\LocaleType', [], Guess::HIGH_CONFIDENCE);
            case 'Symfony\\Component\\Validator\\Constraints\\Time':
                return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\TimeType', ['input' => 'string'], Guess::HIGH_CONFIDENCE);
            case 'Symfony\\Component\\Validator\\Constraints\\Url':
                return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\UrlType', [], Guess::HIGH_CONFIDENCE);
            case 'Symfony\\Component\\Validator\\Constraints\\Ip':
                return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\TextType', [], Guess::MEDIUM_CONFIDENCE);
            case 'Symfony\\Component\\Validator\\Constraints\\Length':
            case 'Symfony\\Component\\Validator\\Constraints\\Regex':
                return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\TextType', [], Guess::LOW_CONFIDENCE);
            case 'Symfony\\Component\\Validator\\Constraints\\Range':
                return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\NumberType', [], Guess::LOW_CONFIDENCE);
            case 'Symfony\\Component\\Validator\\Constraints\\Count':
                return new TypeGuess('Isolated\\Symfony\\Component\\Form\\Extension\\Core\\Type\\CollectionType', [], Guess::LOW_CONFIDENCE);
    ...
    public function guessRequiredForConstraint(Constraint $constraint)
    {
        switch (\get_class($constraint)) {
            ...
            case 'Symfony\\Component\\Validator\\Constraints\\IsTrue':
                return new ValueGuess(\true, Guess::HIGH_CONFIDENCE);
        }
        return null;
    }
    /**
