...
use Isolated\Doctrine\DBAL\DriverManager;
use Isolated\Symfony\Component\Cache\Adapter\AbstractAdapter;
...
class SessionHandlerFactory
{
    ...
    public static function createHandler($connection) : AbstractSessionHandler
    {
        ...
        switch (\true) {
            ...
            case $connection instanceof \Isolated\Predis\ClientInterface:
