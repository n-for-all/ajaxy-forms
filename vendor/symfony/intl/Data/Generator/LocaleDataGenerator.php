...
class LocaleDataGenerator extends AbstractDataGenerator
{
    ...
    protected function compileTemporaryBundles(BundleCompilerInterface $compiler, string $sourceDir, string $tempDir)
    {
        ...
        $filesystem->mkdir([$tempDir . '/lang', $tempDir . '/region']);
    ...
    protected function preGenerate()
    {
        ...
        \file_put_contents(__DIR__ . '/../../../Translation/Resources/data/parents.json', \json_encode($this->localeParents, \JSON_PRETTY_PRINT) . \PHP_EOL);
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        return ['Locales' => $this->locales, 'Aliases' => $this->localeAliases];
    }
