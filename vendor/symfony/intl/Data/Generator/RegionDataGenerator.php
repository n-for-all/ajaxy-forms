...
class RegionDataGenerator extends AbstractDataGenerator
{
     ...
     */
    private const PREFERRED_ALPHA2_TO_ALPHA3_MAPPING = ['CD' => 'COD', 'DE' => 'DEU', 'FR' => 'FRA', 'MM' => 'MMR', 'TL' => 'TLS', 'YE' => 'YEM'];
    ...
    protected function generateDataForLocale(BundleEntryReaderInterface $reader, string $tempDir, string $displayLocale) : ?array
    {
        ...
        if (isset($localeBundle['Countries']) && null !== $localeBundle['Countries']) {
            $data = ['Names' => $this->generateRegionNames($localeBundle)];
    ...
    protected function generateDataForMeta(BundleEntryReaderInterface $reader, string $tempDir) : ?array
    {
        ...
        return ['Regions' => $this->regionCodes, 'Alpha2ToAlpha3' => $alpha2ToAlpha3, 'Alpha3ToAlpha2' => $alpha3ToAlpha2];
    }
