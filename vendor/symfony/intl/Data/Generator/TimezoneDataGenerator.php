...
class TimezoneDataGenerator extends AbstractDataGenerator
{
    ...
    protected function generateDataForLocale(BundleEntryReaderInterface $reader, string $tempDir, string $displayLocale) : ?array
    {
        ...
        $data = ['Names' => $this->generateZones($reader, $tempDir, $displayLocale), 'Meta' => self::generateZoneMetadata($localeBundle)];
    ...
    protected function generateDataForRoot(BundleEntryReaderInterface $reader, string $tempDir) : ?array
    {
        ...
        return ['Meta' => self::generateZoneMetadata($rootBundle)];
    }
    /**
     * {@inheritdoc}
     */
    protected function generateDataForMeta(BundleEntryReaderInterface $reader, string $tempDir) : ?array
    {
        ...
        $data = ['Zones' => $this->zoneIds, 'ZoneToCountry' => $this->zoneToCountryMapping, 'CountryToZone' => self::generateCountryToZoneMapping($this->zoneToCountryMapping)];
        return $data;
    }
