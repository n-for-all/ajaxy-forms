...
\define('Isolated\\LINE_WIDTH', 75);
\define('Isolated\\LINE', \str_repeat('-', \Isolated\LINE_WIDTH) . "\n");
function bailout(string $message)
{
    echo \wordwrap($message, \Isolated\LINE_WIDTH) . " Aborting.\n";
    exit(1);
}
...
{
    $padding = (int) ((\Isolated\LINE_WIDTH - \strlen($text)) / 2);
