 ...
 */
namespace Isolated\Symfony\Component\PasswordHasher\Command;
...
use Isolated\Symfony\Component\Console\Output\ConsoleOutputInterface;
use Isolated\Symfony\Component\Console\Output\OutputInterface;
use Isolated\Symfony\Component\Console\Question\Question;
...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output) : int
    {
        ...
        $rows = [['Hasher used', \get_class($hasher)], ['Password hash', $hashedPassword]];
        if (!$emptySalt) {
