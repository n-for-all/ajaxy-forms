...
use Isolated\Symfony\Component\Security\Core\Encoder\EncoderAwareInterface;
use Isolated\Symfony\Component\Security\Core\Encoder\PasswordEncoderInterface;
use Isolated\Symfony\Component\Security\Core\Encoder\PasswordHasherAdapter;
/**
...
class PasswordHasherFactory implements PasswordHasherFactoryInterface
{
    ...
    private function createHasherUsingAdapter(string $hasherKey) : PasswordHasherInterface
    {
        if (!$this->passwordHashers[$hasherKey] instanceof PasswordHasherInterface) {
            $this->passwordHashers[$hasherKey] = $this->passwordHashers[$hasherKey] instanceof PasswordEncoderInterface ? new PasswordHasherAdapter($this->passwordHashers[$hasherKey]) : $this->createHasher($this->passwordHashers[$hasherKey]);
        }
