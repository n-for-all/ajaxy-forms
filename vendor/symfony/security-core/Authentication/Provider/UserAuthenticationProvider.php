...
use Isolated\Symfony\Component\Security\Core\Exception\CustomUserMessageAccountStatusException;
...
abstract class UserAuthenticationProvider implements AuthenticationProviderInterface
{
     ...
     */
    public function __construct(UserCheckerInterface $userChecker, string $providerKey, bool $hideUserNotFoundExceptions = \true)
    {
     ...
     */
    protected abstract function retrieveUser(string $username, UsernamePasswordToken $token);
    /**
     ...
     * @throws AuthenticationException if the credentials could not be validated
     */
    protected abstract function checkAuthentication(UserInterface $user, UsernamePasswordToken $token);
}
