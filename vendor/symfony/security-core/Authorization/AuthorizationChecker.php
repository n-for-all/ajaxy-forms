...
use Isolated\Symfony\Component\Security\Core\Authentication\Token\NullToken;
...
class AuthorizationChecker implements AuthorizationCheckerInterface
{
    ...
    )
    {
        if ($accessDecisionManager instanceof AuthenticationManagerInterface) {
            ...
            $exceptionOnNoToken = \func_num_args() > 4 ? \func_get_arg(4) : \true;
        }
     ...
     */
    public final function isGranted($attribute, $subject = null) : bool
    {
