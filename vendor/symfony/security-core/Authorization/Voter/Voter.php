...
abstract class Voter implements VoterInterface, CacheableVoterInterface
{
     ...
     * @return bool
     */
    protected abstract function supports(string $attribute, $subject);
    /**
     ...
     * @return bool
     */
    protected abstract function voteOnAttribute(string $attribute, $subject, TokenInterface $token);
}
