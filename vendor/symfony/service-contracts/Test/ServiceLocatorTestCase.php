 ...
 */
namespace Isolated\Symfony\Contracts\Service\Test;

use Isolated\PHPUnit\Framework\TestCase;
use Isolated\Psr\Container\ContainerInterface;
use Isolated\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTestCase extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\Isolated\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\Isolated\Psr\Container\ContainerExceptionInterface::class);
