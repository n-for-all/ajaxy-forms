 ...
 */
namespace Isolated\Symfony\Component\String;

use Isolated\Symfony\Component\String\Exception\ExceptionInterface;
use Isolated\Symfony\Component\String\Exception\InvalidArgumentException;
use Isolated\Symfony\Component\String\Exception\RuntimeException;
/**
...
abstract class AbstractUnicodeString extends AbstractString
{
    ...
    {
        $str = $this->camel();
        $str->string = \mb_strtolower(\preg_replace(['/(\\p{Lu}+)(\\p{Lu}\\p{Ll})/u', '/([\\p{Ll}0-9])(\\p{Lu})/u'], 'Isolated\\1_\\2', $str->string), 'UTF-8');
        return $str;
    }
