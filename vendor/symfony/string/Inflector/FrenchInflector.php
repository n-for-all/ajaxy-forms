 ...
 */
namespace Isolated\Symfony\Component\String\Inflector;
...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // French titles
        ['/^(mon|ma)(sieur|dame|demoiselle|seigneur)$/', 'Isolated\\mes\\2s'],
        ['/^(Mon|Ma)(sieur|dame|demoiselle|seigneur)$/', 'Isolated\\Mes\\2s'],
    ];
    /**
    ...
    private const SINGULARIZE_REGEXP = [
        ...
        // French titles
        ['/^mes(dame|demoiselle)s$/', 'Isolated\\ma\\1'],
        ['/^Mes(dame|demoiselle)s$/', 'Isolated\\Ma\\1'],
        ['/^mes(sieur|seigneur)s$/', 'Isolated\\mon\\1'],
        ['/^Mes(sieur|seigneur)s$/', 'Isolated\\Mon\\1'],
        // Default rule
        ['/s$/i', ''],
    ];
