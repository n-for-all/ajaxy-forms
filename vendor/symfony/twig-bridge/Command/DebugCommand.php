 ...
 */
namespace Isolated\Symfony\Bridge\Twig\Command;
...
use Isolated\Symfony\Component\Console\Formatter\OutputFormatter;
...
use Isolated\Twig\Loader\ChainLoader;
use Isolated\Twig\Loader\FilesystemLoader;
/**
...
class DebugCommand extends Command
{
    ...
    {
        $this->setDefinition([new InputArgument('name', InputArgument::OPTIONAL, 'The template name'), new InputOption('filter', null, InputOption::VALUE_REQUIRED, 'Show details for all entries matching this filter'), new InputOption('format', null, InputOption::VALUE_REQUIRED, 'The output format (text or json)', 'text')])->setDescription(self::$defaultDescription)->setHelp(<<<'EOF'
