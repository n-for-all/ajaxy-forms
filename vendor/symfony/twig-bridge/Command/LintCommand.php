...
use Isolated\Symfony\Component\Console\CI\GithubActionReporter;
...
use Isolated\Symfony\Component\Console\Exception\RuntimeException;
...
class LintCommand extends Command
{
    ...
    {
        $this->setDescription(self::$defaultDescription)->addOption('format', null, InputOption::VALUE_REQUIRED, 'The output format')->addOption('show-deprecations', null, InputOption::VALUE_NONE, 'Show deprecations as errors')->addArgument('filename', InputArgument::IS_ARRAY, 'A file, a directory or "-" for reading from STDIN')->setHelp(<<<'EOF'
