 ...
 */
namespace Isolated\Symfony\Bridge\Twig\DataCollector;
...
use Isolated\Twig\Profiler\Dumper\HtmlDumper;
use Isolated\Twig\Profiler\Profile;
/**
...
class TwigDataCollector extends DataCollector implements LateDataCollectorInterface
{
    ...
    public function getProfile()
    {
        if (null === $this->profile) {
            $this->profile = \unserialize($this->data['profile'], ['allowed_classes' => ['Twig_Profiler_Profile', 'Isolated\\Twig\\Profiler\\Profile']]);
        }
        return $this->profile;
    }
