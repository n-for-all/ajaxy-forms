...
use Isolated\League\HTMLToMarkdown\HtmlConverter;
use Isolated\Symfony\Component\Mime\BodyRendererInterface;
use Isolated\Symfony\Component\Mime\Exception\InvalidArgumentException;
use Isolated\Symfony\Component\Mime\Message;
...
final class BodyRenderer implements BodyRendererInterface
{
    ...
    public function __construct(Environment $twig, array $context = [])
    {
        ...
        if (\class_exists(HtmlConverter::class)) {
            $this->converter = new HtmlConverter(['hard_break' => \true, 'strip_tags' => \true, 'remove_nodes' => 'head style']);
        }
    }
