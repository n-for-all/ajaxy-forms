...
final class ModuleNode extends Node
{
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        $compiler->write("\n\n");
        if (!$this->getAttribute('index')) {
            $compiler->write("use Isolated\\Twig\\Environment;\n")->write("use Isolated\\Twig\\Error\\LoaderError;\n")->write("use Isolated\\Twig\\Error\\RuntimeError;\n")->write("use Isolated\\Twig\\Extension\\CoreExtension;\n")->write("use Isolated\\Twig\\Extension\\SandboxExtension;\n")->write("use Isolated\\Twig\\Markup;\n")->write("use Isolated\\Twig\\Sandbox\\SecurityError;\n")->write("use Isolated\\Twig\\Sandbox\\SecurityNotAllowedTagError;\n")->write("use Isolated\\Twig\\Sandbox\\SecurityNotAllowedFilterError;\n")->write("use Isolated\\Twig\\Sandbox\\SecurityNotAllowedFunctionError;\n")->write("use Isolated\\Twig\\Source;\n")->write("use Isolated\\Twig\\Template;\n\n");
        }
