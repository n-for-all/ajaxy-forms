...
use Isolated\Twilio\Rest\PreviewMessaging\V1\MessageModels;
...
$message1 = MessageModels::createMessagingV1Message(['to' => $phoneNumber1]);
$message2 = MessageModels::createMessagingV1Message(['to' => $phoneNumber2]);
...
$createMessagesRequest = MessageModels::createCreateMessagesRequest(['messages' => $messages, 'from' => $twilioPurchasedNumber, 'body' => $messageBody]);
// Send a Bulk Message
