...
use Isolated\Twilio\TwiML\VoiceResponse;
// TwiML Say and Play
$say = new \Isolated\Twilio\TwiML\Voice\Say('Hello World!', ['voice' => 'woman']);
$play = new \Isolated\Twilio\TwiML\Voice\Play("https://api.twilio.com/cowbell.mp3", ['loop' => 5]);
