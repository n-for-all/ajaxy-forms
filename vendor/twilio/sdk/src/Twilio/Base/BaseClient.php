...
use Isolated\Twilio\Exceptions\ConfigurationException;
use Isolated\Twilio\Exceptions\TwilioException;
use Isolated\Twilio\Http\Client as HttpClient;
use Isolated\Twilio\Http\CurlClient;
use Isolated\Twilio\Rest\Api;
use Isolated\Twilio\Security\RequestValidator;
use Isolated\Twilio\VersionInfo;
/**
...
class BaseClient
{
     ...
     */
    public function request(string $method, string $uri, array $params = [], array $data = [], array $headers = [], string $username = null, string $password = null, int $timeout = null) : \Isolated\Twilio\Http\Response
    {
     ...
     */
    public function getAccount() : \Isolated\Twilio\Rest\Api\V2010\AccountContext
    {
