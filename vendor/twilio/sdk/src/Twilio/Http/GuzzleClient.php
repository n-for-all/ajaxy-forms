...
namespace Isolated\Twilio\Http;

use Isolated\GuzzleHttp\ClientInterface;
use Isolated\GuzzleHttp\Exception\BadResponseException;
use Isolated\GuzzleHttp\Psr7\Query;
use Isolated\GuzzleHttp\Psr7\Request;
use Isolated\Twilio\Exceptions\HttpException;
