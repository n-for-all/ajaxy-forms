...
use Isolated\Twilio\Rest\Api\V2010;
class Api extends ApiBase
{
     ...
     */
    protected function getAccount() : \Isolated\Twilio\Rest\Api\V2010\AccountContext
    {
        return $this->v2010->account;
    }
    protected function getAccounts() : \Isolated\Twilio\Rest\Api\V2010\AccountList
    {
     ...
     */
    protected function contextAccounts(string $sid) : \Isolated\Twilio\Rest\Api\V2010\AccountContext
    {
     ...
     */
    protected function getAddresses() : \Isolated\Twilio\Rest\Api\V2010\Account\AddressList
    {
     ...
     */
    protected function contextAddresses(string $sid) : \Isolated\Twilio\Rest\Api\V2010\Account\AddressContext
    {
     ...
     */
    protected function getApplications() : \Isolated\Twilio\Rest\Api\V2010\Account\ApplicationList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextApplications(string $sid) : \Isolated\Twilio\Rest\Api\V2010\Account\ApplicationContext
    {
     ...
     */
    protected function getAuthorizedConnectApps() : \Isolated\Twilio\Rest\Api\V2010\Account\AuthorizedConnectAppList
    {
     ...
     */
    protected function contextAuthorizedConnectApps(string $connectAppSid) : \Isolated\Twilio\Rest\Api\V2010\Account\AuthorizedConnectAppContext
    {
     ...
     */
    protected function getAvailablePhoneNumbers() : \Isolated\Twilio\Rest\Api\V2010\Account\AvailablePhoneNumberCountryList
    {
     ...
     */
    protected function contextAvailablePhoneNumbers(string $countryCode) : \Isolated\Twilio\Rest\Api\V2010\Account\AvailablePhoneNumberCountryContext
    {
     ...
     */
    protected function getBalance() : \Isolated\Twilio\Rest\Api\V2010\Account\BalanceList
    {
     ...
     */
    protected function getCalls() : \Isolated\Twilio\Rest\Api\V2010\Account\CallList
    {
     ...
     */
    protected function contextCalls(string $sid) : \Isolated\Twilio\Rest\Api\V2010\Account\CallContext
    {
     ...
     */
    protected function getConferences() : \Isolated\Twilio\Rest\Api\V2010\Account\ConferenceList
    {
     ...
     */
    protected function contextConferences(string $sid) : \Isolated\Twilio\Rest\Api\V2010\Account\ConferenceContext
    {
     ...
     */
    protected function getConnectApps() : \Isolated\Twilio\Rest\Api\V2010\Account\ConnectAppList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextConnectApps(string $sid) : \Isolated\Twilio\Rest\Api\V2010\Account\ConnectAppContext
    {
     ...
     */
    protected function getIncomingPhoneNumbers() : \Isolated\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumberList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextIncomingPhoneNumbers(string $sid) : \Isolated\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumberContext
    {
     ...
     */
    protected function getKeys() : \Isolated\Twilio\Rest\Api\V2010\Account\KeyList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextKeys(string $sid) : \Isolated\Twilio\Rest\Api\V2010\Account\KeyContext
    {
     ...
     */
    protected function getMessages() : \Isolated\Twilio\Rest\Api\V2010\Account\MessageList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextMessages(string $sid) : \Isolated\Twilio\Rest\Api\V2010\Account\MessageContext
    {
     ...
     */
    protected function getNewKeys() : \Isolated\Twilio\Rest\Api\V2010\Account\NewKeyList
    {
     ...
     */
    protected function getNewSigningKeys() : \Isolated\Twilio\Rest\Api\V2010\Account\NewSigningKeyList
    {
     ...
     */
    protected function getNotifications() : \Isolated\Twilio\Rest\Api\V2010\Account\NotificationList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextNotifications(string $sid) : \Isolated\Twilio\Rest\Api\V2010\Account\NotificationContext
    {
     ...
     */
    protected function getOutgoingCallerIds() : \Isolated\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextOutgoingCallerIds(string $sid) : \Isolated\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdContext
    {
     ...
     */
    protected function getQueues() : \Isolated\Twilio\Rest\Api\V2010\Account\QueueList
    {
     ...
     * @param string $sid The unique string that identifies this resource
     */
    protected function contextQueues(string $sid) : \Isolated\Twilio\Rest\Api\V2010\Account\QueueContext
    {
     ...
     */
    protected function getRecordings() : \Isolated\Twilio\Rest\Api\V2010\Account\RecordingList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextRecordings(string $sid) : \Isolated\Twilio\Rest\Api\V2010\Account\RecordingContext
    {
     ...
     */
    protected function getSigningKeys() : \Isolated\Twilio\Rest\Api\V2010\Account\SigningKeyList
    {
     ...
     */
    protected function contextSigningKeys(string $sid) : \Isolated\Twilio\Rest\Api\V2010\Account\SigningKeyContext
    {
     ...
     */
    protected function getSip() : \Isolated\Twilio\Rest\Api\V2010\Account\SipList
    {
     ...
     */
    protected function getShortCodes() : \Isolated\Twilio\Rest\Api\V2010\Account\ShortCodeList
    {
     ...
     * @param string $sid The unique string that identifies this resource
     */
    protected function contextShortCodes(string $sid) : \Isolated\Twilio\Rest\Api\V2010\Account\ShortCodeContext
    {
     ...
     */
    protected function getTokens() : \Isolated\Twilio\Rest\Api\V2010\Account\TokenList
    {
     ...
     */
    protected function getTranscriptions() : \Isolated\Twilio\Rest\Api\V2010\Account\TranscriptionList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextTranscriptions(string $sid) : \Isolated\Twilio\Rest\Api\V2010\Account\TranscriptionContext
    {
     ...
     */
    protected function getUsage() : \Isolated\Twilio\Rest\Api\V2010\Account\UsageList
    {
     ...
     */
    protected function getValidationRequests() : \Isolated\Twilio\Rest\Api\V2010\Account\ValidationRequestList
    {
