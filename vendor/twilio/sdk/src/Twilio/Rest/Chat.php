...
use Isolated\Twilio\Rest\Chat\V2;
use Isolated\Twilio\Rest\Chat\V3;
class Chat extends ChatBase
{
    /**
     * @deprecated Use v2->credentials instead.
     */
    protected function getCredentials() : \Isolated\Twilio\Rest\Chat\V2\CredentialList
    {
     ...
     */
    protected function contextCredentials(string $sid) : \Isolated\Twilio\Rest\Chat\V2\CredentialContext
    {
     ...
     */
    protected function getServices() : \Isolated\Twilio\Rest\Chat\V2\ServiceList
    {
     ...
     */
    protected function contextServices(string $sid) : \Isolated\Twilio\Rest\Chat\V2\ServiceContext
    {
     ...
     */
    protected function getChannels() : \Isolated\Twilio\Rest\Chat\V3\ChannelList
    {
     ...
     */
    protected function contextChannels(string $serviceSid, string $sid) : \Isolated\Twilio\Rest\Chat\V3\ChannelContext
    {
