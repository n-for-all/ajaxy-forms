...
class TwilioMedia implements \JsonSerializable
{
    ...
    public function jsonSerialize() : array
    {
        return ['body' => $this->body, 'media' => $this->media];
    }
}
class TwilioLocation implements \JsonSerializable
{
    ...
    public function jsonSerialize() : array
    {
        return ['latitude' => $this->latitude, 'longitude' => $this->longitude, 'label' => $this->label];
    }
}
class ListItem implements \JsonSerializable
{
    ...
    public function jsonSerialize() : array
    {
        return ['id' => $this->id, 'item' => $this->item, 'description' => $this->description];
    }
}
class TwilioListPicker implements \JsonSerializable
{
    ...
    public function jsonSerialize() : array
    {
        return ['body' => $this->body, 'button' => $this->button, 'items' => $this->items];
    }
}
class CallToActionAction implements \JsonSerializable
{
    ...
    public function jsonSerialize() : array
    {
        return ['type' => $this->type, 'title' => $this->title, 'url' => $this->url, 'phone' => $this->phone, 'id' => $this->id];
    }
}
class TwilioCallToAction implements \JsonSerializable
{
    ...
    public function jsonSerialize() : array
    {
        return ['body' => $this->body, 'actions' => $this->actions];
    }
}
class QuickReplyAction implements \JsonSerializable
{
    ...
    public function jsonSerialize() : array
    {
        return ['type' => $this->type, 'title' => $this->title, 'id' => $this->id];
    }
}
...
class TwilioCard implements \JsonSerializable
{
    ...
    public function jsonSerialize() : array
    {
        return ['title' => $this->title, 'subtitle' => $this->subtitle, 'media' => $this->media, 'actions' => $this->actions];
    }
}
class CatalogItem implements \JsonSerializable
{
    ...
    public function jsonSerialize() : array
    {
        return ['id' => $this->id, 'sectionTitle' => $this->sectionTitle, 'name' => $this->name, 'mediaUrl' => $this->mediaUrl, 'price' => $this->price, 'description' => $this->description];
    }
}
class TwilioCatalog implements \JsonSerializable
{
    ...
    public function jsonSerialize() : array
    {
        return ['title' => $this->title, 'body' => $this->body, 'subtitle' => $this->subtitle, 'id' => $this->id, 'items' => $this->items, 'dynamicItems' => $this->dynamicItems];
    }
}
class WhatsappCard implements \JsonSerializable
{
    ...
    public function jsonSerialize() : array
    {
        return ['body' => $this->body, 'footer' => $this->footer, 'media' => $this->media, 'headerText' => $this->headerText, 'actions' => $this->actions];
    }
}
class AuthenticationAction implements \JsonSerializable
{
    ...
    public function jsonSerialize() : array
    {
        return ['type' => $this->type, 'copyCodeText' => $this->copyCodeText];
    }
}
class WhatsappAuthentication implements \JsonSerializable
{
    ...
    public function jsonSerialize() : array
    {
        return ['addSecurityRecommendation' => $this->addSecurityRecommendation, 'codeExpirationMinutes' => $this->codeExpirationMinutes, 'actions' => $this->actions];
    }
}
...
class ContentCreateRequest implements \JsonSerializable
{
    ...
    public function jsonSerialize() : array
    {
        return ['friendlyName' => $this->friendlyName, 'variables' => $this->variables, 'language' => $this->language, 'types' => $this->types];
    }
}
