...
use Isolated\Twilio\Rest\Conversations\V1;
class Conversations extends ConversationsBase
{
    /**
     * @deprecated Use v1->configuration instead.
     */
    protected function getConfiguration() : \Isolated\Twilio\Rest\Conversations\V1\ConfigurationList
    {
     ...
     * @deprecated Use v1->configuration() instead.
     */
    protected function contextConfiguration() : \Isolated\Twilio\Rest\Conversations\V1\ConfigurationContext
    {
        echo "configuration() is deprecated. Use v1->configuration() instead.";
        return $this->v1->configuration();
    }
     ...
     */
    protected function getAddressConfigurations() : \Isolated\Twilio\Rest\Conversations\V1\AddressConfigurationList
    {
     ...
     */
    protected function contextAddressConfigurations(string $sid) : \Isolated\Twilio\Rest\Conversations\V1\AddressConfigurationContext
    {
     ...
     */
    protected function getConversations() : \Isolated\Twilio\Rest\Conversations\V1\ConversationList
    {
     ...
     *                    resource.
     */
    protected function contextConversations(string $sid) : \Isolated\Twilio\Rest\Conversations\V1\ConversationContext
    {
     ...
     */
    protected function getCredentials() : \Isolated\Twilio\Rest\Conversations\V1\CredentialList
    {
     ...
     *                    resource.
     */
    protected function contextCredentials(string $sid) : \Isolated\Twilio\Rest\Conversations\V1\CredentialContext
    {
     ...
     */
    protected function getParticipantConversations() : \Isolated\Twilio\Rest\Conversations\V1\ParticipantConversationList
    {
     ...
     */
    protected function getRoles() : \Isolated\Twilio\Rest\Conversations\V1\RoleList
    {
     ...
     */
    protected function contextRoles(string $sid) : \Isolated\Twilio\Rest\Conversations\V1\RoleContext
    {
     ...
     */
    protected function getServices() : \Isolated\Twilio\Rest\Conversations\V1\ServiceList
    {
     ...
     *                    resource.
     */
    protected function contextServices(string $sid) : \Isolated\Twilio\Rest\Conversations\V1\ServiceContext
    {
     ...
     */
    protected function getUsers() : \Isolated\Twilio\Rest\Conversations\V1\UserList
    {
     ...
     */
    protected function contextUsers(string $sid) : \Isolated\Twilio\Rest\Conversations\V1\UserContext
    {
