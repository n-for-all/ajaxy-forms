...
use Isolated\Twilio\Rest\FlexApi\V1;
use Isolated\Twilio\Rest\FlexApi\V2;
class FlexApi extends FlexApiBase
{
    /**
     * @deprecated Use v1->assessments instead.
     */
    protected function getAssessments() : \Isolated\Twilio\Rest\FlexApi\V1\AssessmentsList
    {
     ...
     * @deprecated Use v1->assessments() instead.
     */
    protected function contextAssessments() : \Isolated\Twilio\Rest\FlexApi\V1\AssessmentsContext
    {
        echo "assessments() is deprecated. Use v1->assessments() instead.";
        return $this->v1->assessments();
    }
     ...
     */
    protected function getChannel() : \Isolated\Twilio\Rest\FlexApi\V1\ChannelList
    {
     ...
     *                    fetch
     */
    protected function contextChannel(string $sid) : \Isolated\Twilio\Rest\FlexApi\V1\ChannelContext
    {
     ...
     */
    protected function getConfiguration() : \Isolated\Twilio\Rest\FlexApi\V1\ConfigurationList
    {
     ...
     * @deprecated Use v1->configuration() instead.
     */
    protected function contextConfiguration() : \Isolated\Twilio\Rest\FlexApi\V1\ConfigurationContext
    {
        echo "configuration() is deprecated. Use v1->configuration() instead.";
        return $this->v1->configuration();
    }
     ...
     */
    protected function getFlexFlow() : \Isolated\Twilio\Rest\FlexApi\V1\FlexFlowList
    {
     ...
     */
    protected function contextFlexFlow(string $sid) : \Isolated\Twilio\Rest\FlexApi\V1\FlexFlowContext
    {
     ...
     */
    protected function getInteraction() : \Isolated\Twilio\Rest\FlexApi\V1\InteractionList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextInteraction(string $sid) : \Isolated\Twilio\Rest\FlexApi\V1\InteractionContext
    {
     ...
     */
    protected function getWebChannel() : \Isolated\Twilio\Rest\FlexApi\V1\WebChannelList
    {
     ...
     */
    protected function contextWebChannel(string $sid) : \Isolated\Twilio\Rest\FlexApi\V1\WebChannelContext
    {
     ...
     */
    protected function getWebChannels() : \Isolated\Twilio\Rest\FlexApi\V2\WebChannelsList
    {
