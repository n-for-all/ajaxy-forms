...
class AssessmentsInstance extends InstanceResource
{
    ...
    {
        if (!$this->context) {
            $this->context = new AssessmentsContext($this->version, $this->solution['assessmentSid']);
        }
        return $this->context;
    }
    /**
