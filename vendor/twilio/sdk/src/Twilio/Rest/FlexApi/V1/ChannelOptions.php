...
abstract class ChannelOptions
{
     ...
     */
    public static function create(string $target = Values::NONE, string $chatUniqueName = Values::NONE, string $preEngagementData = Values::NONE, string $taskSid = Values::NONE, string $taskAttributes = Values::NONE, bool $longLived = Values::BOOL_NONE) : CreateChannelOptions
    {
...
class CreateChannelOptions extends Options
{
     ...
     * @param bool $longLived Whether to create the channel as long-lived.
     */
    public function __construct(string $target = Values::NONE, string $chatUniqueName = Values::NONE, string $preEngagementData = Values::NONE, string $taskSid = Values::NONE, string $taskAttributes = Values::NONE, bool $longLived = Values::BOOL_NONE)
    {
