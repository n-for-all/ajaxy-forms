...
abstract class InsightsAssessmentsCommentOptions
{
     ...
     */
    public static function create(string $authorization = Values::NONE) : CreateInsightsAssessmentsCommentOptions
    {
     ...
     */
    public static function read(string $segmentId = Values::NONE, string $agentId = Values::NONE, string $authorization = Values::NONE) : ReadInsightsAssessmentsCommentOptions
    {
        return new ReadInsightsAssessmentsCommentOptions($segmentId, $agentId, $authorization);
    }
}
...
class ReadInsightsAssessmentsCommentOptions extends Options
{
     ...
     * @param string $authorization The Authorization HTTP request header
     */
    public function __construct(string $segmentId = Values::NONE, string $agentId = Values::NONE, string $authorization = Values::NONE)
    {
