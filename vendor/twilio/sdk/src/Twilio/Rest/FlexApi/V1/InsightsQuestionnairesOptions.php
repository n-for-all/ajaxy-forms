...
abstract class InsightsQuestionnairesOptions
{
     ...
     */
    public static function create(string $description = Values::NONE, bool $active = Values::BOOL_NONE, array $questionSids = Values::ARRAY_NONE, string $authorization = Values::NONE) : CreateInsightsQuestionnairesOptions
    {
        return new CreateInsightsQuestionnairesOptions($description, $active, $questionSids, $authorization);
    }
    /**
     * @param string $authorization The Authorization HTTP request header
     * @return DeleteInsightsQuestionnairesOptions Options builder
     */
    public static function delete(string $authorization = Values::NONE) : DeleteInsightsQuestionnairesOptions
    {
     ...
     */
    public static function fetch(string $authorization = Values::NONE) : FetchInsightsQuestionnairesOptions
    {
     ...
     */
    public static function read(bool $includeInactive = Values::BOOL_NONE, string $authorization = Values::NONE) : ReadInsightsQuestionnairesOptions
    {
        return new ReadInsightsQuestionnairesOptions($includeInactive, $authorization);
    }
    /**
     ...
     */
    public static function update(string $name = Values::NONE, string $description = Values::NONE, array $questionSids = Values::ARRAY_NONE, string $authorization = Values::NONE) : UpdateInsightsQuestionnairesOptions
    {
        return new UpdateInsightsQuestionnairesOptions($name, $description, $questionSids, $authorization);
    }
}
class CreateInsightsQuestionnairesOptions extends Options
{
     ...
     * @param string $authorization The Authorization HTTP request header
     */
    public function __construct(string $description = Values::NONE, bool $active = Values::BOOL_NONE, array $questionSids = Values::ARRAY_NONE, string $authorization = Values::NONE)
    {
...
class ReadInsightsQuestionnairesOptions extends Options
{
     ...
     * @param string $authorization The Authorization HTTP request header
     */
    public function __construct(bool $includeInactive = Values::BOOL_NONE, string $authorization = Values::NONE)
    {
...
class UpdateInsightsQuestionnairesOptions extends Options
{
     ...
     * @param string $authorization The Authorization HTTP request header
     */
    public function __construct(string $name = Values::NONE, string $description = Values::NONE, array $questionSids = Values::ARRAY_NONE, string $authorization = Values::NONE)
    {
