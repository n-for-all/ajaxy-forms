...
abstract class InsightsQuestionnairesQuestionOptions
{
     ...
     */
    public static function create(string $description = Values::NONE, string $authorization = Values::NONE) : CreateInsightsQuestionnairesQuestionOptions
    {
        return new CreateInsightsQuestionnairesQuestionOptions($description, $authorization);
    }
    /**
     * @param string $authorization The Authorization HTTP request header
     * @return DeleteInsightsQuestionnairesQuestionOptions Options builder
     */
    public static function delete(string $authorization = Values::NONE) : DeleteInsightsQuestionnairesQuestionOptions
    {
     ...
     */
    public static function read(array $categorySid = Values::ARRAY_NONE, string $authorization = Values::NONE) : ReadInsightsQuestionnairesQuestionOptions
    {
        return new ReadInsightsQuestionnairesQuestionOptions($categorySid, $authorization);
    }
    /**
     ...
     */
    public static function update(string $categorySid = Values::NONE, string $question = Values::NONE, string $description = Values::NONE, string $answerSetId = Values::NONE, string $authorization = Values::NONE) : UpdateInsightsQuestionnairesQuestionOptions
    {
        return new UpdateInsightsQuestionnairesQuestionOptions($categorySid, $question, $description, $answerSetId, $authorization);
    }
}
class CreateInsightsQuestionnairesQuestionOptions extends Options
{
     ...
     * @param string $authorization The Authorization HTTP request header
     */
    public function __construct(string $description = Values::NONE, string $authorization = Values::NONE)
    {
...
class ReadInsightsQuestionnairesQuestionOptions extends Options
{
     ...
     * @param string $authorization The Authorization HTTP request header
     */
    public function __construct(array $categorySid = Values::ARRAY_NONE, string $authorization = Values::NONE)
    {
...
class UpdateInsightsQuestionnairesQuestionOptions extends Options
{
     ...
     * @param string $authorization The Authorization HTTP request header
     */
    public function __construct(string $categorySid = Values::NONE, string $question = Values::NONE, string $description = Values::NONE, string $answerSetId = Values::NONE, string $authorization = Values::NONE)
    {
        $this->options['categorySid'] = $categorySid;
