...
abstract class InteractionChannelParticipantOptions
{
     ...
     */
    public static function create(array $routingProperties = Values::ARRAY_NONE) : CreateInteractionChannelParticipantOptions
    {
        return new CreateInteractionChannelParticipantOptions($routingProperties);
    }
}
