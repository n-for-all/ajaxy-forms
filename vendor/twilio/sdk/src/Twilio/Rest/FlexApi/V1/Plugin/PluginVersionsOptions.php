...
abstract class PluginVersionsOptions
{
     ...
     */
    public static function create(string $changelog = Values::NONE, bool $private = Values::BOOL_NONE, string $cliVersion = Values::NONE, string $validateStatus = Values::NONE, string $flexMetadata = Values::NONE) : CreatePluginVersionsOptions
    {
        return new CreatePluginVersionsOptions($changelog, $private, $cliVersion, $validateStatus, $flexMetadata);
    }
    /**
     * @param string $flexMetadata The Flex-Metadata HTTP request header
     * @return FetchPluginVersionsOptions Options builder
     */
    public static function fetch(string $flexMetadata = Values::NONE) : FetchPluginVersionsOptions
    {
     ...
     */
    public static function read(string $flexMetadata = Values::NONE) : ReadPluginVersionsOptions
    {
...
class CreatePluginVersionsOptions extends Options
{
     ...
     * @param string $flexMetadata The Flex-Metadata HTTP request header
     */
    public function __construct(string $changelog = Values::NONE, bool $private = Values::BOOL_NONE, string $cliVersion = Values::NONE, string $validateStatus = Values::NONE, string $flexMetadata = Values::NONE)
    {
