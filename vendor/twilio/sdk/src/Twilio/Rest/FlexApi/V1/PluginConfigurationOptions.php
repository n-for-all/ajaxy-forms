...
abstract class PluginConfigurationOptions
{
     ...
     */
    public static function create(array $plugins = Values::ARRAY_NONE, string $description = Values::NONE, string $flexMetadata = Values::NONE) : CreatePluginConfigurationOptions
    {
        return new CreatePluginConfigurationOptions($plugins, $description, $flexMetadata);
    }
    /**
     * @param string $flexMetadata The Flex-Metadata HTTP request header
     * @return FetchPluginConfigurationOptions Options builder
     */
    public static function fetch(string $flexMetadata = Values::NONE) : FetchPluginConfigurationOptions
    {
     ...
     */
    public static function read(string $flexMetadata = Values::NONE) : ReadPluginConfigurationOptions
    {
...
class CreatePluginConfigurationOptions extends Options
{
     ...
     * @param string $flexMetadata The Flex-Metadata HTTP request header
     */
    public function __construct(array $plugins = Values::ARRAY_NONE, string $description = Values::NONE, string $flexMetadata = Values::NONE)
    {
