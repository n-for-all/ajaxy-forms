...
class PluginList extends ListResource
{
    ...
    public function create(string $uniqueName, array $options = []) : PluginInstance
    {
        ...
        $data = Values::of(['UniqueName' => $uniqueName, 'FriendlyName' => $options['friendlyName'], 'Description' => $options['description']]);
     ...
     */
    public function page($pageSize = Values::NONE, string $pageToken = Values::NONE, $pageNumber = Values::NONE) : PluginPage
    {
