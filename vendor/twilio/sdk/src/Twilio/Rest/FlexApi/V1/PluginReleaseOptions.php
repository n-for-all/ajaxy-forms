...
abstract class PluginReleaseOptions
{
     ...
     */
    public static function create(string $flexMetadata = Values::NONE) : CreatePluginReleaseOptions
    {
     ...
     */
    public static function fetch(string $flexMetadata = Values::NONE) : FetchPluginReleaseOptions
    {
     ...
     */
    public static function read(string $flexMetadata = Values::NONE) : ReadPluginReleaseOptions
    {
