...
abstract class WebChannelsOptions
{
     ...
     */
    public static function create(string $chatFriendlyName = Values::NONE, string $customerFriendlyName = Values::NONE, string $preEngagementData = Values::NONE, string $uiVersion = Values::NONE) : CreateWebChannelsOptions
    {
        return new CreateWebChannelsOptions($chatFriendlyName, $customerFriendlyName, $preEngagementData, $uiVersion);
    }
}
class CreateWebChannelsOptions extends Options
{
     ...
     * @param string $uiVersion The Ui-Version HTTP request header
     */
    public function __construct(string $chatFriendlyName = Values::NONE, string $customerFriendlyName = Values::NONE, string $preEngagementData = Values::NONE, string $uiVersion = Values::NONE)
    {
