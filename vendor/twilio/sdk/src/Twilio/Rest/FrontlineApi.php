...
use Isolated\Twilio\Rest\FrontlineApi\V1;
class FrontlineApi extends FrontlineApiBase
{
    /**
     * @deprecated Use v1->users instead.
     */
    protected function getUsers() : \Isolated\Twilio\Rest\FrontlineApi\V1\UserList
    {
     ...
     */
    protected function contextUsers(string $sid) : \Isolated\Twilio\Rest\FrontlineApi\V1\UserContext
    {
