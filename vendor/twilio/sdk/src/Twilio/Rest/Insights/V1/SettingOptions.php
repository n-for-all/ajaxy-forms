...
abstract class SettingOptions
{
     ...
     */
    public static function update(bool $advancedFeatures = Values::BOOL_NONE, bool $voiceTrace = Values::BOOL_NONE, string $subaccountSid = Values::NONE) : UpdateSettingOptions
    {
...
class UpdateSettingOptions extends Options
{
     ...
     * @param string $subaccountSid The unique SID identifier of the Subaccount.
     */
    public function __construct(bool $advancedFeatures = Values::BOOL_NONE, bool $voiceTrace = Values::BOOL_NONE, string $subaccountSid = Values::NONE)
    {
