...
class OperatorAttachmentInstance extends InstanceResource
{
    ...
    public function __construct(Version $version, array $payload, string $serviceSid = null, string $operatorSid = null)
    {
        ...
        $this->properties = ['serviceSid' => Values::array_get($payload, 'service_sid'), 'operatorSid' => Values::array_get($payload, 'operator_sid'), 'url' => Values::array_get($payload, 'url')];
    ...
    {
        if (!$this->context) {
            $this->context = new OperatorAttachmentContext($this->version, $this->solution['serviceSid'], $this->solution['operatorSid']);
        }
        return $this->context;
    }
    /**
