...
class ServiceList extends ListResource
{
    ...
    public function create(string $uniqueName, array $options = []) : ServiceInstance
    {
        ...
        $data = Values::of(['UniqueName' => $uniqueName, 'AutoTranscribe' => Serialize::booleanToString($options['autoTranscribe']), 'DataLogging' => Serialize::booleanToString($options['dataLogging']), 'FriendlyName' => $options['friendlyName'], 'LanguageCode' => $options['languageCode'], 'AutoRedaction' => Serialize::booleanToString($options['autoRedaction']), 'MediaRedaction' => Serialize::booleanToString($options['mediaRedaction']), 'WebhookUrl' => $options['webhookUrl'], 'WebhookHttpMethod' => $options['webhookHttpMethod']]);
