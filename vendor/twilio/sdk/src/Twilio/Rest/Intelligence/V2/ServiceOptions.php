...
abstract class ServiceOptions
{
     ...
     */
    public static function create(bool $autoTranscribe = Values::BOOL_NONE, bool $dataLogging = Values::BOOL_NONE, string $friendlyName = Values::NONE, string $languageCode = Values::NONE, bool $autoRedaction = Values::BOOL_NONE, bool $mediaRedaction = Values::BOOL_NONE, string $webhookUrl = Values::NONE, string $webhookHttpMethod = Values::NONE) : CreateServiceOptions
    {
        return new CreateServiceOptions($autoTranscribe, $dataLogging, $friendlyName, $languageCode, $autoRedaction, $mediaRedaction, $webhookUrl, $webhookHttpMethod);
    }
    /**
     * @param bool $autoTranscribe Instructs the Speech Recognition service to automatically transcribe all recordings made on the account.
     * @param bool $dataLogging Data logging allows Twilio to improve the quality of the speech recognition & language understanding services through using customer data to refine, fine tune and evaluate machine learning models. Note: Data logging cannot be activated via API, only via www.twilio.com, as it requires additional consent.
     ...
     */
    public static function update(bool $autoTranscribe = Values::BOOL_NONE, bool $dataLogging = Values::BOOL_NONE, string $friendlyName = Values::NONE, string $uniqueName = Values::NONE, bool $autoRedaction = Values::BOOL_NONE, bool $mediaRedaction = Values::BOOL_NONE, string $webhookUrl = Values::NONE, string $webhookHttpMethod = Values::NONE, string $ifMatch = Values::NONE) : UpdateServiceOptions
    {
        return new UpdateServiceOptions($autoTranscribe, $dataLogging, $friendlyName, $uniqueName, $autoRedaction, $mediaRedaction, $webhookUrl, $webhookHttpMethod, $ifMatch);
    }
}
class CreateServiceOptions extends Options
{
     ...
     * @param string $webhookHttpMethod
     */
    public function __construct(bool $autoTranscribe = Values::BOOL_NONE, bool $dataLogging = Values::BOOL_NONE, string $friendlyName = Values::NONE, string $languageCode = Values::NONE, bool $autoRedaction = Values::BOOL_NONE, bool $mediaRedaction = Values::BOOL_NONE, string $webhookUrl = Values::NONE, string $webhookHttpMethod = Values::NONE)
    {
...
class UpdateServiceOptions extends Options
{
     ...
     * @param string $ifMatch The If-Match HTTP request header
     */
    public function __construct(bool $autoTranscribe = Values::BOOL_NONE, bool $dataLogging = Values::BOOL_NONE, string $friendlyName = Values::NONE, string $uniqueName = Values::NONE, bool $autoRedaction = Values::BOOL_NONE, bool $mediaRedaction = Values::BOOL_NONE, string $webhookUrl = Values::NONE, string $webhookHttpMethod = Values::NONE, string $ifMatch = Values::NONE)
    {
        $this->options['autoTranscribe'] = $autoTranscribe;
        $this->options['dataLogging'] = $dataLogging;
        $this->options['friendlyName'] = $friendlyName;
