...
use Isolated\Twilio\Rest\Lookups\V1;
class Lookups extends LookupsBase
{
    /**
     * @deprecated Use v1->phoneNumbers instead.
     */
    protected function getPhoneNumbers() : \Isolated\Twilio\Rest\Lookups\V1\PhoneNumberList
    {
     ...
     */
    protected function contextPhoneNumbers(string $phoneNumber) : \Isolated\Twilio\Rest\Lookups\V1\PhoneNumberContext
    {
