...
use Isolated\Twilio\Rest\Messaging\V1;
class Messaging extends MessagingBase
{
    /**
     * @deprecated
     */
    protected function getBrandRegistrations() : \Isolated\Twilio\Rest\Messaging\V1\BrandRegistrationList
    {
     ...
     */
    protected function contextBrandRegistrations(string $sid) : \Isolated\Twilio\Rest\Messaging\V1\BrandRegistrationContext
    {
     ...
     * @deprecated
     */
    protected function getDeactivations() : \Isolated\Twilio\Rest\Messaging\V1\DeactivationsList
    {
     ...
     */
    protected function contextDeactivations() : \Isolated\Twilio\Rest\Messaging\V1\DeactivationsContext
    {
        echo "deactivations() is deprecated. Use v1->deactivations() instead.";
        return $this->v1->deactivations();
    }
     ...
     */
    protected function getDomainCerts() : \Isolated\Twilio\Rest\Messaging\V1\DomainCertsList
    {
     ...
     */
    protected function contextDomainCerts(string $domainSid) : \Isolated\Twilio\Rest\Messaging\V1\DomainCertsContext
    {
     ...
     */
    protected function getDomainConfig() : \Isolated\Twilio\Rest\Messaging\V1\DomainConfigList
    {
     ...
     */
    protected function contextDomainConfig(string $domainSid) : \Isolated\Twilio\Rest\Messaging\V1\DomainConfigContext
    {
     ...
     */
    protected function getExternalCampaign() : \Isolated\Twilio\Rest\Messaging\V1\ExternalCampaignList
    {
     ...
     */
    protected function getServices() : \Isolated\Twilio\Rest\Messaging\V1\ServiceList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextServices(string $sid) : \Isolated\Twilio\Rest\Messaging\V1\ServiceContext
    {
     ...
     */
    protected function getTollfreeVerifications() : \Isolated\Twilio\Rest\Messaging\V1\TollfreeVerificationList
    {
     ...
     */
    protected function contextTollfreeVerifications(string $sid) : \Isolated\Twilio\Rest\Messaging\V1\TollfreeVerificationContext
    {
     ...
     */
    protected function getUsecases() : \Isolated\Twilio\Rest\Messaging\V1\UsecaseList
    {
