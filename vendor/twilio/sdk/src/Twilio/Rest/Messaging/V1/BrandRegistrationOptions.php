...
abstract class BrandRegistrationOptions
{
     ...
     */
    public static function create(string $brandType = Values::NONE, bool $mock = Values::BOOL_NONE, bool $skipAutomaticSecVet = Values::BOOL_NONE) : CreateBrandRegistrationOptions
    {
...
class CreateBrandRegistrationOptions extends Options
{
     ...
     * @param bool $skipAutomaticSecVet A flag to disable automatic secondary vetting for brands which it would otherwise be done.
     */
    public function __construct(string $brandType = Values::NONE, bool $mock = Values::BOOL_NONE, bool $skipAutomaticSecVet = Values::BOOL_NONE)
    {
