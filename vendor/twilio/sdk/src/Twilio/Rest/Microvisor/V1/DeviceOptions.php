...
abstract class DeviceOptions
{
     ...
     */
    public static function update(string $uniqueName = Values::NONE, string $targetApp = Values::NONE, bool $loggingEnabled = Values::BOOL_NONE, bool $restartApp = Values::BOOL_NONE) : UpdateDeviceOptions
    {
        return new UpdateDeviceOptions($uniqueName, $targetApp, $loggingEnabled, $restartApp);
    }
}
class UpdateDeviceOptions extends Options
{
     ...
     * @param bool $restartApp Set to true to restart the App running on the Device.
     */
    public function __construct(string $uniqueName = Values::NONE, string $targetApp = Values::NONE, bool $loggingEnabled = Values::BOOL_NONE, bool $restartApp = Values::BOOL_NONE)
    {
