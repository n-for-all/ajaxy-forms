...
abstract class PortingPortabilityOptions
{
     ...
     */
    public static function fetch(string $targetAccountSid = Values::NONE) : FetchPortingPortabilityOptions
    {
        return new FetchPortingPortabilityOptions($targetAccountSid);
    }
}
class FetchPortingPortabilityOptions extends Options
{
     ...
     * @param string $targetAccountSid The SID of the account where the phone number(s) will be ported.
     */
    public function __construct(string $targetAccountSid = Values::NONE)
    {
