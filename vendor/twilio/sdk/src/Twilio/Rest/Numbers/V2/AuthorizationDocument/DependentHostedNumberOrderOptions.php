...
abstract class DependentHostedNumberOrderOptions
{
     ...
     */
    public static function read(string $status = Values::NONE, string $phoneNumber = Values::NONE, string $incomingPhoneNumberSid = Values::NONE, string $friendlyName = Values::NONE) : ReadDependentHostedNumberOrderOptions
    {
...
class ReadDependentHostedNumberOrderOptions extends Options
{
     ...
     * @param string $friendlyName A human readable description of this resource, up to 128 characters.
     */
    public function __construct(string $status = Values::NONE, string $phoneNumber = Values::NONE, string $incomingPhoneNumberSid = Values::NONE, string $friendlyName = Values::NONE)
    {
