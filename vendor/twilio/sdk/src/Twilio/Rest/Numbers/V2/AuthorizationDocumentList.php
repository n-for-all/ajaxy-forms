...
class AuthorizationDocumentList extends ListResource
{
    ...
    public function create(string $addressSid, string $email, string $contactPhoneNumber, array $hostedNumberOrderSids, array $options = []) : AuthorizationDocumentInstance
    {
        ...
        $data = Values::of(['AddressSid' => $addressSid, 'Email' => $email, 'ContactPhoneNumber' => $contactPhoneNumber, 'HostedNumberOrderSids' => Serialize::map($hostedNumberOrderSids, function ($e) {
            return $e;
        }), 'ContactTitle' => $options['contactTitle'], 'CcEmails' => Serialize::map($options['ccEmails'], function ($e) {
            return $e;
        })]);
