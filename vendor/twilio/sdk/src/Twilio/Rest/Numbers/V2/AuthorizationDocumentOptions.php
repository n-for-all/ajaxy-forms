...
abstract class AuthorizationDocumentOptions
{
     ...
     */
    public static function create(string $contactTitle = Values::NONE, array $ccEmails = Values::ARRAY_NONE) : CreateAuthorizationDocumentOptions
    {
...
class CreateAuthorizationDocumentOptions extends Options
{
     ...
     * @param string[] $ccEmails Email recipients who will be informed when an Authorization Document has been sent and signed.
     */
    public function __construct(string $contactTitle = Values::NONE, array $ccEmails = Values::ARRAY_NONE)
    {
