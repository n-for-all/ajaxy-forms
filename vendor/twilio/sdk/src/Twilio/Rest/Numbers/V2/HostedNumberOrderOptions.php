...
abstract class HostedNumberOrderOptions
{
     ...
     */
    public static function create(string $accountSid = Values::NONE, string $friendlyName = Values::NONE, array $ccEmails = Values::ARRAY_NONE, string $smsUrl = Values::NONE, string $smsMethod = Values::NONE, string $smsFallbackUrl = Values::NONE, bool $smsCapability = Values::BOOL_NONE, string $smsFallbackMethod = Values::NONE, string $statusCallbackUrl = Values::NONE, string $statusCallbackMethod = Values::NONE, string $smsApplicationSid = Values::NONE, string $contactTitle = Values::NONE) : CreateHostedNumberOrderOptions
    {
        return new CreateHostedNumberOrderOptions($accountSid, $friendlyName, $ccEmails, $smsUrl, $smsMethod, $smsFallbackUrl, $smsCapability, $smsFallbackMethod, $statusCallbackUrl, $statusCallbackMethod, $smsApplicationSid, $contactTitle);
    }
    /**
     ...
     */
    public static function read(string $status = Values::NONE, bool $smsCapability = Values::BOOL_NONE, string $phoneNumber = Values::NONE, string $incomingPhoneNumberSid = Values::NONE, string $friendlyName = Values::NONE) : ReadHostedNumberOrderOptions
    {
        return new ReadHostedNumberOrderOptions($status, $smsCapability, $phoneNumber, $incomingPhoneNumberSid, $friendlyName);
    }
}
class CreateHostedNumberOrderOptions extends Options
{
     ...
     * @param string $contactTitle The title of the person authorized to sign the Authorization Document for this phone number.
     */
    public function __construct(string $accountSid = Values::NONE, string $friendlyName = Values::NONE, array $ccEmails = Values::ARRAY_NONE, string $smsUrl = Values::NONE, string $smsMethod = Values::NONE, string $smsFallbackUrl = Values::NONE, bool $smsCapability = Values::BOOL_NONE, string $smsFallbackMethod = Values::NONE, string $statusCallbackUrl = Values::NONE, string $statusCallbackMethod = Values::NONE, string $smsApplicationSid = Values::NONE, string $contactTitle = Values::NONE)
    {
...
class ReadHostedNumberOrderOptions extends Options
{
     ...
     * @param string $friendlyName A human readable description of this resource, up to 128 characters.
     */
    public function __construct(string $status = Values::NONE, bool $smsCapability = Values::BOOL_NONE, string $phoneNumber = Values::NONE, string $incomingPhoneNumberSid = Values::NONE, string $friendlyName = Values::NONE)
    {
