...
abstract class AuthorizeOptions
{
     ...
     */
    public static function fetch(string $responseType = Values::NONE, string $clientId = Values::NONE, string $redirectUri = Values::NONE, string $scope = Values::NONE, string $state = Values::NONE) : FetchAuthorizeOptions
    {
        return new FetchAuthorizeOptions($responseType, $clientId, $redirectUri, $scope, $state);
    }
}
class FetchAuthorizeOptions extends Options
{
     ...
     * @param string $state An opaque value which can be used to maintain state between the request and callback
     */
    public function __construct(string $responseType = Values::NONE, string $clientId = Values::NONE, string $redirectUri = Values::NONE, string $scope = Values::NONE, string $state = Values::NONE)
    {
