...
abstract class TokenOptions
{
     ...
     */
    public static function create(string $clientSecret = Values::NONE, string $code = Values::NONE, string $redirectUri = Values::NONE, string $audience = Values::NONE, string $refreshToken = Values::NONE, string $scope = Values::NONE) : CreateTokenOptions
    {
        return new CreateTokenOptions($clientSecret, $code, $redirectUri, $audience, $refreshToken, $scope);
    }
}
class CreateTokenOptions extends Options
{
     ...
     * @param string $scope The scope of token
     */
    public function __construct(string $clientSecret = Values::NONE, string $code = Values::NONE, string $redirectUri = Values::NONE, string $audience = Values::NONE, string $refreshToken = Values::NONE, string $scope = Values::NONE)
    {
