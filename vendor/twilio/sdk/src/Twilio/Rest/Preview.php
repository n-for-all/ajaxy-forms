...
class Preview extends PreviewBase
{
     ...
     */
    protected function getFleets() : \Isolated\Twilio\Rest\Preview\DeployedDevices\FleetList
    {
     ...
     */
    protected function contextFleets(string $sid) : \Isolated\Twilio\Rest\Preview\DeployedDevices\FleetContext
    {
     ...
     */
    protected function getAuthorizationDocuments() : \Isolated\Twilio\Rest\Preview\HostedNumbers\AuthorizationDocumentList
    {
     ...
     */
    protected function contextAuthorizationDocuments(string $sid) : \Isolated\Twilio\Rest\Preview\HostedNumbers\AuthorizationDocumentContext
    {
     ...
     */
    protected function getHostedNumberOrders() : \Isolated\Twilio\Rest\Preview\HostedNumbers\HostedNumberOrderList
    {
     ...
     */
    protected function contextHostedNumberOrders(string $sid) : \Isolated\Twilio\Rest\Preview\HostedNumbers\HostedNumberOrderContext
    {
     ...
     */
    protected function getAvailableAddOns() : \Isolated\Twilio\Rest\Preview\Marketplace\AvailableAddOnList
    {
     ...
     */
    protected function contextAvailableAddOns(string $sid) : \Isolated\Twilio\Rest\Preview\Marketplace\AvailableAddOnContext
    {
     ...
     */
    protected function getInstalledAddOns() : \Isolated\Twilio\Rest\Preview\Marketplace\InstalledAddOnList
    {
     ...
     */
    protected function contextInstalledAddOns(string $sid) : \Isolated\Twilio\Rest\Preview\Marketplace\InstalledAddOnContext
    {
     ...
     */
    protected function getServices() : \Isolated\Twilio\Rest\Preview\Sync\ServiceList
    {
     ...
     */
    protected function contextServices(string $sid) : \Isolated\Twilio\Rest\Preview\Sync\ServiceContext
    {
     ...
     */
    protected function getAssistants() : \Isolated\Twilio\Rest\Preview\Understand\AssistantList
    {
     ...
     *                    resource.
     */
    protected function contextAssistants(string $sid) : \Isolated\Twilio\Rest\Preview\Understand\AssistantContext
    {
     ...
     */
    protected function getCommands() : \Isolated\Twilio\Rest\Preview\Wireless\CommandList
    {
     ...
     * @param string $sid The sid
     */
    protected function contextCommands(string $sid) : \Isolated\Twilio\Rest\Preview\Wireless\CommandContext
    {
     ...
     */
    protected function getRatePlans() : \Isolated\Twilio\Rest\Preview\Wireless\RatePlanList
    {
     ...
     * @param string $sid The sid
     */
    protected function contextRatePlans(string $sid) : \Isolated\Twilio\Rest\Preview\Wireless\RatePlanContext
    {
     ...
     */
    protected function getSims() : \Isolated\Twilio\Rest\Preview\Wireless\SimList
    {
     ...
     * @param string $sid The sid
     */
    protected function contextSims(string $sid) : \Isolated\Twilio\Rest\Preview\Wireless\SimContext
    {
