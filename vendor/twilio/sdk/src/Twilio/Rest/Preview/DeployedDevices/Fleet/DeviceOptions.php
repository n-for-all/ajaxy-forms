...
abstract class DeviceOptions
{
     ...
     */
    public static function create(string $uniqueName = Values::NONE, string $friendlyName = Values::NONE, string $identity = Values::NONE, string $deploymentSid = Values::NONE, bool $enabled = Values::BOOL_NONE) : CreateDeviceOptions
    {
     ...
     */
    public static function update(string $friendlyName = Values::NONE, string $identity = Values::NONE, string $deploymentSid = Values::NONE, bool $enabled = Values::BOOL_NONE) : UpdateDeviceOptions
    {
...
class CreateDeviceOptions extends Options
{
     ...
     * @param bool $enabled 
     */
    public function __construct(string $uniqueName = Values::NONE, string $friendlyName = Values::NONE, string $identity = Values::NONE, string $deploymentSid = Values::NONE, bool $enabled = Values::BOOL_NONE)
    {
...
class UpdateDeviceOptions extends Options
{
     ...
     * @param bool $enabled 
     */
    public function __construct(string $friendlyName = Values::NONE, string $identity = Values::NONE, string $deploymentSid = Values::NONE, bool $enabled = Values::BOOL_NONE)
    {
        $this->options['friendlyName'] = $friendlyName;
        $this->options['identity'] = $identity;
        $this->options['deploymentSid'] = $deploymentSid;
