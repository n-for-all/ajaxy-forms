...
abstract class RatePlanOptions
{
     ...
     */
    public static function create(string $uniqueName = Values::NONE, string $friendlyName = Values::NONE, bool $dataEnabled = Values::BOOL_NONE, int $dataLimit = Values::INT_NONE, string $dataMetering = Values::NONE, bool $messagingEnabled = Values::BOOL_NONE, bool $voiceEnabled = Values::BOOL_NONE, bool $commandsEnabled = Values::BOOL_NONE, bool $nationalRoamingEnabled = Values::BOOL_NONE, array $internationalRoaming = Values::ARRAY_NONE) : CreateRatePlanOptions
    {
