...
use Isolated\Twilio\Rest\Pricing\V1;
use Isolated\Twilio\Rest\Pricing\V2;
class Pricing extends PricingBase
{
    /**
     * @deprecated Use v1->messaging instead.
     */
    protected function getMessaging() : \Isolated\Twilio\Rest\Pricing\V1\MessagingList
    {
     ...
     */
    protected function getPhoneNumbers() : \Isolated\Twilio\Rest\Pricing\V1\PhoneNumberList
    {
     ...
     */
    protected function getVoice() : \Isolated\Twilio\Rest\Pricing\V2\VoiceList
    {
     ...
     */
    protected function getCountries() : \Isolated\Twilio\Rest\Pricing\V2\CountryList
    {
     ...
     *                           fetch
     */
    protected function contextCountries(string $isoCountry) : \Isolated\Twilio\Rest\Pricing\V2\CountryContext
    {
     ...
     */
    protected function getNumbers() : \Isolated\Twilio\Rest\Pricing\V2\NumberList
    {
     ...
     *                                  pricing information
     */
    protected function contextNumbers(string $destinationNumber) : \Isolated\Twilio\Rest\Pricing\V2\NumberContext
    {
