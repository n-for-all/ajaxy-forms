...
use Isolated\Twilio\Rest\Proxy\V1;
class Proxy extends ProxyBase
{
    /**
     * @deprecated Use v1->services instead.
     */
    protected function getServices() : \Isolated\Twilio\Rest\Proxy\V1\ServiceList
    {
     ...
     */
    protected function contextServices(string $sid) : \Isolated\Twilio\Rest\Proxy\V1\ServiceContext
    {
