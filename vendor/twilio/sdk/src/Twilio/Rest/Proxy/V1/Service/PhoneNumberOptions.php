...
abstract class PhoneNumberOptions
{
     ...
     */
    public static function create(string $sid = Values::NONE, string $phoneNumber = Values::NONE, bool $isReserved = Values::BOOL_NONE) : CreatePhoneNumberOptions
    {
     ...
     */
    public static function update(bool $isReserved = Values::BOOL_NONE) : UpdatePhoneNumberOptions
    {
...
class CreatePhoneNumberOptions extends Options
{
     ...
     * @param bool $isReserved Whether the new phone number should be reserved and not be assigned to a participant using proxy pool logic. See [Reserved Phone Numbers](https://www.twilio.com/docs/proxy/reserved-phone-numbers) for more information.
     */
    public function __construct(string $sid = Values::NONE, string $phoneNumber = Values::NONE, bool $isReserved = Values::BOOL_NONE)
    {
