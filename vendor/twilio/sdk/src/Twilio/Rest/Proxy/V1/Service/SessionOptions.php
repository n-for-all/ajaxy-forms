...
abstract class SessionOptions
{
     ...
     */
    public static function create(string $uniqueName = Values::NONE, \DateTime $dateExpiry = null, int $ttl = Values::INT_NONE, string $mode = Values::NONE, string $status = Values::NONE, array $participants = Values::ARRAY_NONE) : CreateSessionOptions
    {
     ...
     */
    public static function update(\DateTime $dateExpiry = null, int $ttl = Values::INT_NONE, string $status = Values::NONE) : UpdateSessionOptions
    {
...
class CreateSessionOptions extends Options
{
     ...
     * @param array[] $participants The Participant objects to include in the new session.
     */
    public function __construct(string $uniqueName = Values::NONE, \DateTime $dateExpiry = null, int $ttl = Values::INT_NONE, string $mode = Values::NONE, string $status = Values::NONE, array $participants = Values::ARRAY_NONE)
    {
...
class UpdateSessionOptions extends Options
{
     ...
     * @param string $status
     */
    public function __construct(\DateTime $dateExpiry = null, int $ttl = Values::INT_NONE, string $status = Values::NONE)
    {
        $this->options['dateExpiry'] = $dateExpiry;
        $this->options['ttl'] = $ttl;
        $this->options['status'] = $status;
