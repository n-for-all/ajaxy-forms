...
abstract class LogOptions
{
     ...
     */
    public static function read(string $functionSid = Values::NONE, \DateTime $startDate = null, \DateTime $endDate = null) : ReadLogOptions
    {
...
class ReadLogOptions extends Options
{
     ...
     * @param \DateTime $endDate The date/time (in GMT, ISO 8601) before which the Log resources must have been created. Defaults to current date/time.
     */
    public function __construct(string $functionSid = Values::NONE, \DateTime $startDate = null, \DateTime $endDate = null)
    {
