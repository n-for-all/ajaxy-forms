...
use Isolated\Twilio\Rest\Supersim\V1;
class Supersim extends SupersimBase
{
    /**
     * @deprecated Use v1->esimProfiles instead.
     */
    protected function getEsimProfiles() : \Isolated\Twilio\Rest\Supersim\V1\EsimProfileList
    {
     ...
     */
    protected function contextEsimProfiles(string $sid) : \Isolated\Twilio\Rest\Supersim\V1\EsimProfileContext
    {
     ...
     */
    protected function getFleets() : \Isolated\Twilio\Rest\Supersim\V1\FleetList
    {
     ...
     */
    protected function contextFleets(string $sid) : \Isolated\Twilio\Rest\Supersim\V1\FleetContext
    {
     ...
     */
    protected function getIpCommands() : \Isolated\Twilio\Rest\Supersim\V1\IpCommandList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextIpCommands(string $sid) : \Isolated\Twilio\Rest\Supersim\V1\IpCommandContext
    {
     ...
     */
    protected function getNetworks() : \Isolated\Twilio\Rest\Supersim\V1\NetworkList
    {
     ...
     */
    protected function contextNetworks(string $sid) : \Isolated\Twilio\Rest\Supersim\V1\NetworkContext
    {
     ...
     */
    protected function getNetworkAccessProfiles() : \Isolated\Twilio\Rest\Supersim\V1\NetworkAccessProfileList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextNetworkAccessProfiles(string $sid) : \Isolated\Twilio\Rest\Supersim\V1\NetworkAccessProfileContext
    {
     ...
     */
    protected function getSettingsUpdates() : \Isolated\Twilio\Rest\Supersim\V1\SettingsUpdateList
    {
     ...
     */
    protected function getSims() : \Isolated\Twilio\Rest\Supersim\V1\SimList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextSims(string $sid) : \Isolated\Twilio\Rest\Supersim\V1\SimContext
    {
     ...
     */
    protected function getSmsCommands() : \Isolated\Twilio\Rest\Supersim\V1\SmsCommandList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextSmsCommands(string $sid) : \Isolated\Twilio\Rest\Supersim\V1\SmsCommandContext
    {
     ...
     */
    protected function getUsageRecords() : \Isolated\Twilio\Rest\Supersim\V1\UsageRecordList
    {
