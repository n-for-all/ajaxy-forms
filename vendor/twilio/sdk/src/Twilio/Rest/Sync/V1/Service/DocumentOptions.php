...
abstract class DocumentOptions
{
     ...
     */
    public static function create(string $uniqueName = Values::NONE, array $data = Values::ARRAY_NONE, int $ttl = Values::INT_NONE) : CreateDocumentOptions
    {
     ...
     */
    public static function update(array $data = Values::ARRAY_NONE, int $ttl = Values::INT_NONE, string $ifMatch = Values::NONE) : UpdateDocumentOptions
    {
...
class CreateDocumentOptions extends Options
{
     ...
     * @param int $ttl How long, [in seconds](https://www.twilio.com/docs/sync/limits#sync-payload-limits), before the Sync Document expires and is deleted (the Sync Document's time-to-live).
     */
    public function __construct(string $uniqueName = Values::NONE, array $data = Values::ARRAY_NONE, int $ttl = Values::INT_NONE)
    {
...
class UpdateDocumentOptions extends Options
{
     ...
     * @param string $ifMatch The If-Match HTTP request header
     */
    public function __construct(array $data = Values::ARRAY_NONE, int $ttl = Values::INT_NONE, string $ifMatch = Values::NONE)
    {
        $this->options['data'] = $data;
        $this->options['ttl'] = $ttl;
