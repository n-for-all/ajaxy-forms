 ...
 */
namespace Isolated\Twilio\Rest\Sync\V1\Service\SyncList;
...
abstract class SyncListItemOptions
{
     ...
     */
    public static function create(int $ttl = Values::INT_NONE, int $itemTtl = Values::INT_NONE, int $collectionTtl = Values::INT_NONE) : CreateSyncListItemOptions
    {
     ...
     */
    public static function update(array $data = Values::ARRAY_NONE, int $ttl = Values::INT_NONE, int $itemTtl = Values::INT_NONE, int $collectionTtl = Values::INT_NONE, string $ifMatch = Values::NONE) : UpdateSyncListItemOptions
    {
...
class CreateSyncListItemOptions extends Options
{
     ...
     * @param int $collectionTtl How long, [in seconds](https://www.twilio.com/docs/sync/limits#sync-payload-limits), before the List Item's parent Sync List expires (time-to-live) and is deleted.
     */
    public function __construct(int $ttl = Values::INT_NONE, int $itemTtl = Values::INT_NONE, int $collectionTtl = Values::INT_NONE)
    {
...
class UpdateSyncListItemOptions extends Options
{
     ...
     * @param string $ifMatch If provided, applies this mutation if (and only if) the “revision” field of this [map item] matches the provided value. This matches the semantics of (and is implemented with) the HTTP [If-Match header](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/If-Match).
     */
    public function __construct(array $data = Values::ARRAY_NONE, int $ttl = Values::INT_NONE, int $itemTtl = Values::INT_NONE, int $collectionTtl = Values::INT_NONE, string $ifMatch = Values::NONE)
    {
