...
abstract class SyncListOptions
{
     ...
     */
    public static function create(string $uniqueName = Values::NONE, int $ttl = Values::INT_NONE, int $collectionTtl = Values::INT_NONE) : CreateSyncListOptions
    {
     ...
     */
    public static function update(int $ttl = Values::INT_NONE, int $collectionTtl = Values::INT_NONE) : UpdateSyncListOptions
    {
...
class CreateSyncListOptions extends Options
{
     ...
     * @param int $collectionTtl How long, [in seconds](https://www.twilio.com/docs/sync/limits#sync-payload-limits), before the Sync List expires (time-to-live) and is deleted.
     */
    public function __construct(string $uniqueName = Values::NONE, int $ttl = Values::INT_NONE, int $collectionTtl = Values::INT_NONE)
    {
...
class UpdateSyncListOptions extends Options
{
     ...
     * @param int $collectionTtl How long, [in seconds](https://www.twilio.com/docs/sync/limits#sync-payload-limits), before the Sync List expires (time-to-live) and is deleted.
     */
    public function __construct(int $ttl = Values::INT_NONE, int $collectionTtl = Values::INT_NONE)
    {
        $this->options['ttl'] = $ttl;
        $this->options['collectionTtl'] = $collectionTtl;
    }
