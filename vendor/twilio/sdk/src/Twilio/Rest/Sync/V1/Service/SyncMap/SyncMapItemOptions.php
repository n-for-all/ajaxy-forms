...
abstract class SyncMapItemOptions
{
     ...
     */
    public static function create(int $ttl = Values::INT_NONE, int $itemTtl = Values::INT_NONE, int $collectionTtl = Values::INT_NONE) : CreateSyncMapItemOptions
    {
     ...
     */
    public static function update(array $data = Values::ARRAY_NONE, int $ttl = Values::INT_NONE, int $itemTtl = Values::INT_NONE, int $collectionTtl = Values::INT_NONE, string $ifMatch = Values::NONE) : UpdateSyncMapItemOptions
    {
