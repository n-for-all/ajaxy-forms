...
abstract class SyncMapOptions
{
     ...
     */
    public static function create(string $uniqueName = Values::NONE, int $ttl = Values::INT_NONE, int $collectionTtl = Values::INT_NONE) : CreateSyncMapOptions
    {
     ...
     */
    public static function update(int $ttl = Values::INT_NONE, int $collectionTtl = Values::INT_NONE) : UpdateSyncMapOptions
    {
