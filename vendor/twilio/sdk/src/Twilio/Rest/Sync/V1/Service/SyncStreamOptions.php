...
abstract class SyncStreamOptions
{
     ...
     */
    public static function create(string $uniqueName = Values::NONE, int $ttl = Values::INT_NONE) : CreateSyncStreamOptions
    {
     ...
     */
    public static function update(int $ttl = Values::INT_NONE) : UpdateSyncStreamOptions
    {
...
class CreateSyncStreamOptions extends Options
{
     ...
     * @param int $ttl How long, [in seconds](https://www.twilio.com/docs/sync/limits#sync-payload-limits), before the Stream expires and is deleted (time-to-live).
     */
    public function __construct(string $uniqueName = Values::NONE, int $ttl = Values::INT_NONE)
    {
