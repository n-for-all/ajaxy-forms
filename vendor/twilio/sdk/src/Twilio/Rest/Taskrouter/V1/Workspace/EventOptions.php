...
abstract class EventOptions
{
     ...
     */
    public static function read(\DateTime $endDate = null, string $eventType = Values::NONE, int $minutes = Values::INT_NONE, string $reservationSid = Values::NONE, \DateTime $startDate = null, string $taskQueueSid = Values::NONE, string $taskSid = Values::NONE, string $workerSid = Values::NONE, string $workflowSid = Values::NONE, string $taskChannel = Values::NONE, string $sid = Values::NONE) : ReadEventOptions
    {
...
class ReadEventOptions extends Options
{
     ...
     * @param string $sid The SID of the Event resource to read.
     */
    public function __construct(\DateTime $endDate = null, string $eventType = Values::NONE, int $minutes = Values::INT_NONE, string $reservationSid = Values::NONE, \DateTime $startDate = null, string $taskQueueSid = Values::NONE, string $taskSid = Values::NONE, string $workerSid = Values::NONE, string $workflowSid = Values::NONE, string $taskChannel = Values::NONE, string $sid = Values::NONE)
    {
