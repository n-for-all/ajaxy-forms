...
use Isolated\Twilio\Rest\Taskrouter\V1\Workspace\Task\ReservationList;
/**
...
class TaskContext extends InstanceContext
{
    ...
    {
        $options = new Values($options);
        $data = Values::of(['Attributes' => $options['attributes'], 'AssignmentStatus' => $options['assignmentStatus'], 'Reason' => $options['reason'], 'Priority' => $options['priority'], 'TaskChannel' => $options['taskChannel'], 'VirtualStartTime' => Serialize::iso8601DateTime($options['virtualStartTime'])]);
        $headers = Values::of(['If-Match' => $options['ifMatch']]);
