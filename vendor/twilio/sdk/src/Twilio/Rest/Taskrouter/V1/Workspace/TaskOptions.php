...
abstract class TaskOptions
{
     ...
     */
    public static function create(int $timeout = Values::INT_NONE, int $priority = Values::INT_NONE, string $taskChannel = Values::NONE, string $workflowSid = Values::NONE, string $attributes = Values::NONE, \DateTime $virtualStartTime = null, string $routingTarget = Values::NONE, string $ignoreCapacity = Values::NONE, string $taskQueueSid = Values::NONE) : CreateTaskOptions
    {
        return new CreateTaskOptions($timeout, $priority, $taskChannel, $workflowSid, $attributes, $virtualStartTime, $routingTarget, $ignoreCapacity, $taskQueueSid);
    }
    /**
     ...
     */
    public static function read(int $priority = Values::INT_NONE, array $assignmentStatus = Values::ARRAY_NONE, string $workflowSid = Values::NONE, string $workflowName = Values::NONE, string $taskQueueSid = Values::NONE, string $taskQueueName = Values::NONE, string $evaluateTaskAttributes = Values::NONE, string $routingTarget = Values::NONE, string $ordering = Values::NONE, bool $hasAddons = Values::BOOL_NONE) : ReadTaskOptions
    {
        return new ReadTaskOptions($priority, $assignmentStatus, $workflowSid, $workflowName, $taskQueueSid, $taskQueueName, $evaluateTaskAttributes, $routingTarget, $ordering, $hasAddons);
    }
    /**
     ...
     */
    public static function update(string $attributes = Values::NONE, string $assignmentStatus = Values::NONE, string $reason = Values::NONE, int $priority = Values::INT_NONE, string $taskChannel = Values::NONE, \DateTime $virtualStartTime = null, string $ifMatch = Values::NONE) : UpdateTaskOptions
    {
        return new UpdateTaskOptions($attributes, $assignmentStatus, $reason, $priority, $taskChannel, $virtualStartTime, $ifMatch);
    }
}
class CreateTaskOptions extends Options
{
     ...
     * @param string $taskQueueSid The SID of the TaskQueue in which the Task belongs
     */
    public function __construct(int $timeout = Values::INT_NONE, int $priority = Values::INT_NONE, string $taskChannel = Values::NONE, string $workflowSid = Values::NONE, string $attributes = Values::NONE, \DateTime $virtualStartTime = null, string $routingTarget = Values::NONE, string $ignoreCapacity = Values::NONE, string $taskQueueSid = Values::NONE)
    {
...
class ReadTaskOptions extends Options
{
     ...
     * @param bool $hasAddons Whether to read Tasks with Add-ons. If `true`, returns only Tasks with Add-ons. If `false`, returns only Tasks without Add-ons.
     */
    public function __construct(int $priority = Values::INT_NONE, array $assignmentStatus = Values::ARRAY_NONE, string $workflowSid = Values::NONE, string $workflowName = Values::NONE, string $taskQueueSid = Values::NONE, string $taskQueueName = Values::NONE, string $evaluateTaskAttributes = Values::NONE, string $routingTarget = Values::NONE, string $ordering = Values::NONE, bool $hasAddons = Values::BOOL_NONE)
    {
        $this->options['priority'] = $priority;
...
class UpdateTaskOptions extends Options
{
     ...
     * @param string $ifMatch If provided, applies this mutation if (and only if) the [ETag](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/ETag) header of the Task matches the provided value. This matches the semantics of (and is implemented with) the HTTP [If-Match header](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/If-Match).
     */
    public function __construct(string $attributes = Values::NONE, string $assignmentStatus = Values::NONE, string $reason = Values::NONE, int $priority = Values::INT_NONE, string $taskChannel = Values::NONE, \DateTime $virtualStartTime = null, string $ifMatch = Values::NONE)
    {
        $this->options['attributes'] = $attributes;
        $this->options['assignmentStatus'] = $assignmentStatus;
