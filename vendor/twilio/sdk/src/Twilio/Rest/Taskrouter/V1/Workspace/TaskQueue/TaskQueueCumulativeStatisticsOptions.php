...
abstract class TaskQueueCumulativeStatisticsOptions
{
     ...
     */
    public static function fetch(\DateTime $endDate = null, int $minutes = Values::INT_NONE, \DateTime $startDate = null, string $taskChannel = Values::NONE, string $splitByWaitTime = Values::NONE) : FetchTaskQueueCumulativeStatisticsOptions
    {
...
class FetchTaskQueueCumulativeStatisticsOptions extends Options
{
     ...
     * @param string $splitByWaitTime A comma separated list of values that describes the thresholds, in seconds, to calculate statistics on. For each threshold specified, the number of Tasks canceled and reservations accepted above and below the specified thresholds in seconds are computed. TaskRouter will calculate statistics on up to 10,000 Tasks/Reservations for any given threshold.
     */
    public function __construct(\DateTime $endDate = null, int $minutes = Values::INT_NONE, \DateTime $startDate = null, string $taskChannel = Values::NONE, string $splitByWaitTime = Values::NONE)
    {
