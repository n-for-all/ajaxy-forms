...
abstract class TaskQueuesStatisticsOptions
{
     ...
     */
    public static function read(\DateTime $endDate = null, string $friendlyName = Values::NONE, int $minutes = Values::INT_NONE, \DateTime $startDate = null, string $taskChannel = Values::NONE, string $splitByWaitTime = Values::NONE) : ReadTaskQueuesStatisticsOptions
    {
...
class ReadTaskQueuesStatisticsOptions extends Options
{
     ...
     * @param string $splitByWaitTime A comma separated list of values that describes the thresholds, in seconds, to calculate statistics on. For each threshold specified, the number of Tasks canceled and reservations accepted above and below the specified thresholds in seconds are computed.
     */
    public function __construct(\DateTime $endDate = null, string $friendlyName = Values::NONE, int $minutes = Values::INT_NONE, \DateTime $startDate = null, string $taskChannel = Values::NONE, string $splitByWaitTime = Values::NONE)
    {
