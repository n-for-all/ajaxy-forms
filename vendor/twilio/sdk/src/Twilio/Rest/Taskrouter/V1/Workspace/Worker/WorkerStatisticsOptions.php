...
abstract class WorkerStatisticsOptions
{
     ...
     */
    public static function fetch(int $minutes = Values::INT_NONE, \DateTime $startDate = null, \DateTime $endDate = null, string $taskChannel = Values::NONE) : FetchWorkerStatisticsOptions
    {
...
class FetchWorkerStatisticsOptions extends Options
{
     ...
     * @param string $taskChannel Only calculate statistics on this TaskChannel. Can be the TaskChannel's SID or its `unique_name`, such as `voice`, `sms`, or `default`.
     */
    public function __construct(int $minutes = Values::INT_NONE, \DateTime $startDate = null, \DateTime $endDate = null, string $taskChannel = Values::NONE)
    {
