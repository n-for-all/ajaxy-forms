...
abstract class WorkersCumulativeStatisticsOptions
{
     ...
     */
    public static function fetch(\DateTime $endDate = null, int $minutes = Values::INT_NONE, \DateTime $startDate = null, string $taskChannel = Values::NONE) : FetchWorkersCumulativeStatisticsOptions
    {
...
class FetchWorkersCumulativeStatisticsOptions extends Options
{
     ...
     * @param string $taskChannel Only calculate cumulative statistics on this TaskChannel. Can be the TaskChannel's SID or its `unique_name`, such as `voice`, `sms`, or `default`.
     */
    public function __construct(\DateTime $endDate = null, int $minutes = Values::INT_NONE, \DateTime $startDate = null, string $taskChannel = Values::NONE)
    {
