...
abstract class WorkflowStatisticsOptions
{
     ...
     */
    public static function fetch(int $minutes = Values::INT_NONE, \DateTime $startDate = null, \DateTime $endDate = null, string $taskChannel = Values::NONE, string $splitByWaitTime = Values::NONE) : FetchWorkflowStatisticsOptions
    {
