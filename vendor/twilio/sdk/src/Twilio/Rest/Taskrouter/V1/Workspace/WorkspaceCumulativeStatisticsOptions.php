...
abstract class WorkspaceCumulativeStatisticsOptions
{
     ...
     */
    public static function fetch(\DateTime $endDate = null, int $minutes = Values::INT_NONE, \DateTime $startDate = null, string $taskChannel = Values::NONE, string $splitByWaitTime = Values::NONE) : FetchWorkspaceCumulativeStatisticsOptions
    {
