...
use Isolated\Twilio\Rest\Trunking\V1;
class Trunking extends TrunkingBase
{
    /**
     * @deprecated Use v1->trunks instead.
     */
    protected function getTrunks() : \Isolated\Twilio\Rest\Trunking\V1\TrunkList
    {
     ...
     */
    protected function contextTrunks(string $sid) : \Isolated\Twilio\Rest\Trunking\V1\TrunkContext
    {
