...
abstract class OriginationUrlOptions
{
     ...
     */
    public static function update(int $weight = Values::INT_NONE, int $priority = Values::INT_NONE, bool $enabled = Values::BOOL_NONE, string $friendlyName = Values::NONE, string $sipUrl = Values::NONE) : UpdateOriginationUrlOptions
    {
...
class UpdateOriginationUrlOptions extends Options
{
     ...
     * @param string $sipUrl The SIP address you want Twilio to route your Origination calls to. This must be a `sip:` schema. `sips` is NOT supported.
     */
    public function __construct(int $weight = Values::INT_NONE, int $priority = Values::INT_NONE, bool $enabled = Values::BOOL_NONE, string $friendlyName = Values::NONE, string $sipUrl = Values::NONE)
    {
