...
class ComplianceRegistrationInquiriesList extends ListResource
{
     ...
     */
    public function getContext(string $registrationId) : ComplianceRegistrationInquiriesContext
    {
        return new ComplianceRegistrationInquiriesContext($this->version, $registrationId);
    }
    /**
