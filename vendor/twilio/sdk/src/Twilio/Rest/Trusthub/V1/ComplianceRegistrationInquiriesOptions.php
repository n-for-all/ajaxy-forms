...
abstract class ComplianceRegistrationInquiriesOptions
{
     ...
     */
    public static function update(bool $isIsvEmbed = Values::BOOL_NONE, string $themeSetId = Values::NONE) : UpdateComplianceRegistrationInquiriesOptions
    {
        return new UpdateComplianceRegistrationInquiriesOptions($isIsvEmbed, $themeSetId);
    }
}
class CreateComplianceRegistrationInquiriesOptions extends Options
{
     ...
     * @param string $themeSetId Theme id for styling the inquiry form.
     */
    public function __construct(string $businessIdentityType = Values::NONE, string $businessRegistrationAuthority = Values::NONE, string $businessLegalName = Values::NONE, string $notificationEmail = Values::NONE, bool $acceptedNotificationReceipt = Values::BOOL_NONE, string $businessRegistrationNumber = Values::NONE, string $businessWebsiteUrl = Values::NONE, string $friendlyName = Values::NONE, string $authorizedRepresentative1FirstName = Values::NONE, string $authorizedRepresentative1LastName = Values::NONE, string $authorizedRepresentative1Phone = Values::NONE, string $authorizedRepresentative1Email = Values::NONE, string $authorizedRepresentative1DateOfBirth = Values::NONE, string $addressStreet = Values::NONE, string $addressStreetSecondary = Values::NONE, string $addressCity = Values::NONE, string $addressSubdivision = Values::NONE, string $addressPostalCode = Values::NONE, string $addressCountryCode = Values::NONE, string $emergencyAddressStreet = Values::NONE, string $emergencyAddressStreetSecondary = Values::NONE, string $emergencyAddressCity = Values::NONE, string $emergencyAddressSubdivision = Values::NONE, string $emergencyAddressPostalCode = Values::NONE, string $emergencyAddressCountryCode = Values::NONE, bool $useAddressAsEmergencyAddress = Values::BOOL_NONE, string $fileName = Values::NONE, string $file = Values::NONE, string $firstName = Values::NONE, string $lastName = Values::NONE, string $dateOfBirth = Values::NONE, string $individualEmail = Values::NONE, string $individualPhone = Values::NONE, bool $isIsvEmbed = Values::BOOL_NONE, string $isvRegisteringForSelfOrTenant = Values::NONE, string $statusCallbackUrl = Values::NONE, string $themeSetId = Values::NONE)
    {
...
class UpdateComplianceRegistrationInquiriesOptions extends Options
{
     ...
     * @param string $themeSetId Theme id for styling the inquiry form.
     */
    public function __construct(bool $isIsvEmbed = Values::BOOL_NONE, string $themeSetId = Values::NONE)
    {
        $this->options['isIsvEmbed'] = $isIsvEmbed;
        $this->options['themeSetId'] = $themeSetId;
    }
