...
use Isolated\Twilio\Rest\Verify\V2;
class Verify extends VerifyBase
{
    /**
     * @deprecated Use v2->forms instead.
     */
    protected function getForms() : \Isolated\Twilio\Rest\Verify\V2\FormList
    {
     ...
     */
    protected function contextForms(string $formType) : \Isolated\Twilio\Rest\Verify\V2\FormContext
    {
     ...
     */
    protected function getSafelist() : \Isolated\Twilio\Rest\Verify\V2\SafelistList
    {
     ...
     */
    protected function contextSafelist(string $phoneNumber) : \Isolated\Twilio\Rest\Verify\V2\SafelistContext
    {
     ...
     */
    protected function getServices() : \Isolated\Twilio\Rest\Verify\V2\ServiceList
    {
     ...
     */
    protected function contextServices(string $sid) : \Isolated\Twilio\Rest\Verify\V2\ServiceContext
    {
     ...
     */
    protected function getVerificationAttempts() : \Isolated\Twilio\Rest\Verify\V2\VerificationAttemptList
    {
     ...
     */
    protected function contextVerificationAttempts(string $sid) : \Isolated\Twilio\Rest\Verify\V2\VerificationAttemptContext
    {
     ...
     */
    protected function getVerificationAttemptsSummary() : \Isolated\Twilio\Rest\Verify\V2\VerificationAttemptsSummaryList
    {
     ...
     * @deprecated Use v2->verificationAttemptsSummary() instead.
     */
    protected function contextVerificationAttemptsSummary() : \Isolated\Twilio\Rest\Verify\V2\VerificationAttemptsSummaryContext
    {
        echo "verificationAttemptsSummary() is deprecated. Use v2->verificationAttemptsSummary() instead.";
        return $this->v2->verificationAttemptsSummary();
    }
     ...
     */
    protected function getTemplates() : \Isolated\Twilio\Rest\Verify\V2\TemplateList
    {
