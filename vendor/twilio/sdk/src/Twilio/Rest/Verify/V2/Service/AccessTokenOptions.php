...
abstract class AccessTokenOptions
{
     ...
     */
    public static function create(string $factorFriendlyName = Values::NONE, int $ttl = Values::INT_NONE) : CreateAccessTokenOptions
    {
...
class CreateAccessTokenOptions extends Options
{
     ...
     * @param int $ttl How long, in seconds, the access token is valid. Can be an integer between 60 and 300. Default is 60.
     */
    public function __construct(string $factorFriendlyName = Values::NONE, int $ttl = Values::INT_NONE)
    {
