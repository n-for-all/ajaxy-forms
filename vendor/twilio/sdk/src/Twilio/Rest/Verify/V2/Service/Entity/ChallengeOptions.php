...
abstract class ChallengeOptions
{
     ...
     */
    public static function create(\DateTime $expirationDate = null, string $detailsMessage = Values::NONE, array $detailsFields = Values::ARRAY_NONE, array $hiddenDetails = Values::ARRAY_NONE, string $authPayload = Values::NONE) : CreateChallengeOptions
    {
...
class CreateChallengeOptions extends Options
{
     ...
     * @param string $authPayload Optional payload used to verify the Challenge upon creation. Only used with a Factor of type `totp` to carry the TOTP code that needs to be verified. For `TOTP` this value must be between 3 and 8 characters long.
     */
    public function __construct(\DateTime $expirationDate = null, string $detailsMessage = Values::NONE, array $detailsFields = Values::ARRAY_NONE, array $hiddenDetails = Values::ARRAY_NONE, string $authPayload = Values::NONE)
    {
