...
abstract class BucketOptions
{
     ...
     */
    public static function update(int $max = Values::INT_NONE, int $interval = Values::INT_NONE) : UpdateBucketOptions
    {
...
class UpdateBucketOptions extends Options
{
     ...
     * @param int $interval Number of seconds that the rate limit will be enforced over.
     */
    public function __construct(int $max = Values::INT_NONE, int $interval = Values::INT_NONE)
    {
