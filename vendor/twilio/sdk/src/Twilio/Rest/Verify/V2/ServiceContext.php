...
use Isolated\Twilio\Rest\Verify\V2\Service\EntityList;
use Isolated\Twilio\Rest\Verify\V2\Service\VerificationCheckList;
use Isolated\Twilio\Rest\Verify\V2\Service\VerificationList;
use Isolated\Twilio\Rest\Verify\V2\Service\AccessTokenList;
use Isolated\Twilio\Rest\Verify\V2\Service\RateLimitList;
use Isolated\Twilio\Rest\Verify\V2\Service\WebhookList;
use Isolated\Twilio\Rest\Verify\V2\Service\MessagingConfigurationList;
/**
...
class ServiceContext extends InstanceContext
{
    ...
    public function update(array $options = []) : ServiceInstance
    {
        ...
        $data = Values::of(['FriendlyName' => $options['friendlyName'], 'CodeLength' => $options['codeLength'], 'LookupEnabled' => Serialize::booleanToString($options['lookupEnabled']), 'SkipSmsToLandlines' => Serialize::booleanToString($options['skipSmsToLandlines']), 'DtmfInputRequired' => Serialize::booleanToString($options['dtmfInputRequired']), 'TtsName' => $options['ttsName'], 'Psd2Enabled' => Serialize::booleanToString($options['psd2Enabled']), 'DoNotShareWarningEnabled' => Serialize::booleanToString($options['doNotShareWarningEnabled']), 'CustomCodeEnabled' => Serialize::booleanToString($options['customCodeEnabled']), 'Push.IncludeDate' => Serialize::booleanToString($options['pushIncludeDate']), 'Push.ApnCredentialSid' => $options['pushApnCredentialSid'], 'Push.FcmCredentialSid' => $options['pushFcmCredentialSid'], 'Totp.Issuer' => $options['totpIssuer'], 'Totp.TimeStep' => $options['totpTimeStep'], 'Totp.CodeLength' => $options['totpCodeLength'], 'Totp.Skew' => $options['totpSkew'], 'DefaultTemplateSid' => $options['defaultTemplateSid'], 'Whatsapp.MsgServiceSid' => $options['whatsappMsgServiceSid'], 'Whatsapp.From' => $options['whatsappFrom'], 'VerifyEventSubscriptionEnabled' => Serialize::booleanToString($options['verifyEventSubscriptionEnabled'])]);
