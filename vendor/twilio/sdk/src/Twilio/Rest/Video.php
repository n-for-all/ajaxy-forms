...
use Isolated\Twilio\Rest\Video\V1;
class Video extends VideoBase
{
    /**
     * @deprecated Use v1->compositions instead.
     */
    protected function getCompositions() : \Isolated\Twilio\Rest\Video\V1\CompositionList
    {
     ...
     */
    protected function contextCompositions(string $sid) : \Isolated\Twilio\Rest\Video\V1\CompositionContext
    {
     ...
     */
    protected function getCompositionHooks() : \Isolated\Twilio\Rest\Video\V1\CompositionHookList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextCompositionHooks(string $sid) : \Isolated\Twilio\Rest\Video\V1\CompositionHookContext
    {
     ...
     */
    protected function getCompositionSettings() : \Isolated\Twilio\Rest\Video\V1\CompositionSettingsList
    {
     ...
     * @deprecated Use v1->compositionSettings() instead.
     */
    protected function contextCompositionSettings() : \Isolated\Twilio\Rest\Video\V1\CompositionSettingsContext
    {
        echo "compositionSettings() is deprecated. Use v1->compositionSettings() instead.";
        return $this->v1->compositionSettings();
    }
     ...
     */
    protected function getRecordings() : \Isolated\Twilio\Rest\Video\V1\RecordingList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextRecordings(string $sid) : \Isolated\Twilio\Rest\Video\V1\RecordingContext
    {
     ...
     */
    protected function getRecordingSettings() : \Isolated\Twilio\Rest\Video\V1\RecordingSettingsList
    {
     ...
     * @deprecated Use v1->recordingSettings() instead.
     */
    protected function contextRecordingSettings() : \Isolated\Twilio\Rest\Video\V1\RecordingSettingsContext
    {
        echo "recordingSettings() is deprecated. Use v1->recordingSettings() instead.";
        return $this->v1->recordingSettings();
    }
     ...
     */
    protected function getRooms() : \Isolated\Twilio\Rest\Video\V1\RoomList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextRooms(string $sid) : \Isolated\Twilio\Rest\Video\V1\RoomContext
    {
