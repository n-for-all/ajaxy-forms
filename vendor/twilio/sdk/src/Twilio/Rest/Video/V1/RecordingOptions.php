...
abstract class RecordingOptions
{
     ...
     */
    public static function read(string $status = Values::NONE, string $sourceSid = Values::NONE, array $groupingSid = Values::ARRAY_NONE, \DateTime $dateCreatedAfter = null, \DateTime $dateCreatedBefore = null, string $mediaType = Values::NONE) : ReadRecordingOptions
    {
...
class ReadRecordingOptions extends Options
{
     ...
     * @param string $mediaType Read only recordings that have this media type. Can be either `audio` or `video`.
     */
    public function __construct(string $status = Values::NONE, string $sourceSid = Values::NONE, array $groupingSid = Values::ARRAY_NONE, \DateTime $dateCreatedAfter = null, \DateTime $dateCreatedBefore = null, string $mediaType = Values::NONE)
    {
