...
abstract class RoomOptions
{
     ...
     */
    public static function read(string $status = Values::NONE, string $uniqueName = Values::NONE, \DateTime $dateCreatedAfter = null, \DateTime $dateCreatedBefore = null) : ReadRoomOptions
    {
...
class CreateRoomOptions extends Options
{
     ...
     * @param bool $largeRoom When set to true, indicated that this is the large room.
     */
    public function __construct(bool $enableTurn = Values::BOOL_NONE, string $type = Values::NONE, string $uniqueName = Values::NONE, string $statusCallback = Values::NONE, string $statusCallbackMethod = Values::NONE, int $maxParticipants = Values::INT_NONE, bool $recordParticipantsOnConnect = Values::BOOL_NONE, array $videoCodecs = Values::ARRAY_NONE, string $mediaRegion = Values::NONE, array $recordingRules = Values::ARRAY_NONE, bool $audioOnly = Values::BOOL_NONE, int $maxParticipantDuration = Values::INT_NONE, int $emptyRoomTimeout = Values::INT_NONE, int $unusedRoomTimeout = Values::INT_NONE, bool $largeRoom = Values::BOOL_NONE)
    {
...
class ReadRoomOptions extends Options
{
     ...
     * @param \DateTime $dateCreatedBefore Read only rooms that started before this date, given as `YYYY-MM-DD`.
     */
    public function __construct(string $status = Values::NONE, string $uniqueName = Values::NONE, \DateTime $dateCreatedAfter = null, \DateTime $dateCreatedBefore = null)
    {
