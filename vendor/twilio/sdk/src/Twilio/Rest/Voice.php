...
class Voice extends VoiceBase
{
     ...
     */
    protected function getArchivedCalls() : \Isolated\Twilio\Rest\Voice\V1\ArchivedCallList
    {
     ...
     */
    protected function contextArchivedCalls(\DateTime $date, string $sid) : \Isolated\Twilio\Rest\Voice\V1\ArchivedCallContext
    {
     ...
     */
    protected function getByocTrunks() : \Isolated\Twilio\Rest\Voice\V1\ByocTrunkList
    {
     ...
     */
    protected function contextByocTrunks(string $sid) : \Isolated\Twilio\Rest\Voice\V1\ByocTrunkContext
    {
     ...
     */
    protected function getConnectionPolicies() : \Isolated\Twilio\Rest\Voice\V1\ConnectionPolicyList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextConnectionPolicies(string $sid) : \Isolated\Twilio\Rest\Voice\V1\ConnectionPolicyContext
    {
     ...
     */
    protected function getDialingPermissions() : \Isolated\Twilio\Rest\Voice\V1\DialingPermissionsList
    {
     ...
     */
    protected function getIpRecords() : \Isolated\Twilio\Rest\Voice\V1\IpRecordList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextIpRecords(string $sid) : \Isolated\Twilio\Rest\Voice\V1\IpRecordContext
    {
     ...
     */
    protected function getSourceIpMappings() : \Isolated\Twilio\Rest\Voice\V1\SourceIpMappingList
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextSourceIpMappings(string $sid) : \Isolated\Twilio\Rest\Voice\V1\SourceIpMappingContext
    {
