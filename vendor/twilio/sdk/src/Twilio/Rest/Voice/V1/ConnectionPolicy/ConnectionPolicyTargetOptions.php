 ...
 */
namespace Isolated\Twilio\Rest\Voice\V1\ConnectionPolicy;
...
abstract class ConnectionPolicyTargetOptions
{
     ...
     */
    public static function create(string $friendlyName = Values::NONE, int $priority = Values::INT_NONE, int $weight = Values::INT_NONE, bool $enabled = Values::BOOL_NONE) : CreateConnectionPolicyTargetOptions
    {
     ...
     */
    public static function update(string $friendlyName = Values::NONE, string $target = Values::NONE, int $priority = Values::INT_NONE, int $weight = Values::INT_NONE, bool $enabled = Values::BOOL_NONE) : UpdateConnectionPolicyTargetOptions
    {
...
class CreateConnectionPolicyTargetOptions extends Options
{
     ...
     * @param bool $enabled Whether the Target is enabled. The default is `true`.
     */
    public function __construct(string $friendlyName = Values::NONE, int $priority = Values::INT_NONE, int $weight = Values::INT_NONE, bool $enabled = Values::BOOL_NONE)
    {
...
class UpdateConnectionPolicyTargetOptions extends Options
{
     ...
     * @param bool $enabled Whether the Target is enabled.
     */
    public function __construct(string $friendlyName = Values::NONE, string $target = Values::NONE, int $priority = Values::INT_NONE, int $weight = Values::INT_NONE, bool $enabled = Values::BOOL_NONE)
    {
        $this->options['friendlyName'] = $friendlyName;
