...
use Isolated\Twilio\Rest\Wireless\V1;
class Wireless extends WirelessBase
{
    /**
     * @deprecated Use v1->usageRecords instead.
     */
    protected function getUsageRecords() : \Isolated\Twilio\Rest\Wireless\V1\UsageRecordList
    {
     ...
     */
    protected function getCommands() : \Isolated\Twilio\Rest\Wireless\V1\CommandList
    {
     ...
     */
    protected function contextCommands(string $sid) : \Isolated\Twilio\Rest\Wireless\V1\CommandContext
    {
     ...
     */
    protected function getRatePlans() : \Isolated\Twilio\Rest\Wireless\V1\RatePlanList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextRatePlans(string $sid) : \Isolated\Twilio\Rest\Wireless\V1\RatePlanContext
    {
     ...
     */
    protected function getSims() : \Isolated\Twilio\Rest\Wireless\V1\SimList
    {
     ...
     */
    protected function contextSims(string $sid) : \Isolated\Twilio\Rest\Wireless\V1\SimContext
    {
