 ...
 */
namespace Isolated\Twilio\Rest\Wireless\V1;
...
abstract class RatePlanOptions
{
     ...
     */
    public static function create(string $uniqueName = Values::NONE, string $friendlyName = Values::NONE, bool $dataEnabled = Values::BOOL_NONE, int $dataLimit = Values::INT_NONE, string $dataMetering = Values::NONE, bool $messagingEnabled = Values::BOOL_NONE, bool $voiceEnabled = Values::BOOL_NONE, bool $nationalRoamingEnabled = Values::BOOL_NONE, array $internationalRoaming = Values::ARRAY_NONE, int $nationalRoamingDataLimit = Values::INT_NONE, int $internationalRoamingDataLimit = Values::INT_NONE) : CreateRatePlanOptions
    {
...
class CreateRatePlanOptions extends Options
{
     ...
     * @param int $internationalRoamingDataLimit The total data usage (download and upload combined) in Megabytes that the Network allows during one month when roaming outside the United States. Can be up to 2TB.
     */
    public function __construct(string $uniqueName = Values::NONE, string $friendlyName = Values::NONE, bool $dataEnabled = Values::BOOL_NONE, int $dataLimit = Values::INT_NONE, string $dataMetering = Values::NONE, bool $messagingEnabled = Values::BOOL_NONE, bool $voiceEnabled = Values::BOOL_NONE, bool $nationalRoamingEnabled = Values::BOOL_NONE, array $internationalRoaming = Values::ARRAY_NONE, int $nationalRoamingDataLimit = Values::INT_NONE, int $internationalRoamingDataLimit = Values::INT_NONE)
    {
